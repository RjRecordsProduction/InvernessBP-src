...
local match_ui_configs = {
  ...
  match_zone_menu = {
    ...
    path = "/Game/Mod/Lobby/Base/ModeSelection/Match/Match_Item/ChooseZone_Menu_UIBP.ChooseZone_Menu_UIBP",
    isSingleton = false
  },
  ChooseZone_Delay_Tips_UIBP = {
    keyName = "ChooseZone_Delay_Tips_UIBP",
    moduleName = "client.slua.umg.match.ChooseZone_Delay_Tips_UIBP",
    path = "/Game/Mod/Lobby/Split/ModeSelection/Match/Match_Item/ChooseZone_Delay_Tips_UIBP.ChooseZone_Delay_Tips_UIBP"
  },
  mode_selection_main = {
    keyName = "mode_selection_main",
    moduleName = "client.slua.umg.ModeSelection.ModeSelection_Main_UIBP",
    path = "/Game/Mod/Lobby/Split/ModeSelection/ModeSelection_Main_UIBP.ModeSelection_Main_UIBP",
  ...
  mode_selection_anim = {
    ...
    path = "/Game/Mod/Lobby/Base/OpeningTrain/ModeSelection_Opening_UIBP.ModeSelection_Opening_UIBP",
    uiStat = {
  ...
  item_big_mode_selection_main = {
    ...
    path = "/Game/Mod/Lobby/Split/ModeSelection/Item/ModeSelection_Main_Map01_Item.ModeSelection_Main_Map01_Item",
    isSingleton = false,
  ...
  item_peak_mode_selection_main = {
    ...
    path = "/Game/Mod/Lobby/Split/ModeSelection/Item/ModeSelection_Map_Peak_Item.ModeSelection_Map_Peak_Item",
    isSingleton = false,
    isWindowsOBHide = true,
    uiStat = {
  ...
  ModeSelection_Map_Asymmetric_Item = {
    ...
    path = "/Game/Mod/Lobby/Split/ModeSelection/Item/ModeSelection_Main_Map03_Item.ModeSelection_Main_Map03_Item",
    isSingleton = false,
    isWindowsOBHide = true,
    uiStat = {
  ...
  ModeSelection_EscapeCampSelection_Popup_UIBP = {
    ...
    path = "/Game/Mod/Lobby/Split/ModeSelection/Popup/ModeSelection_EscapeCampSelection_Popup_UIBP.ModeSelection_EscapeCampSelection_Popup_UIBP",
    uiStat = {
  ...
  ModeSelection_EscapeCampSelection_Popup01_UIBP = {
    ...
    path = "/Game/Mod/Lobby/Split/ModeSelection/Popup/ModeSelection_EscapeCampSelection_Popup01_UIBP.ModeSelection_EscapeCampSelection_Popup01_UIBP",
    uiStat = {
  ...
  ModeSelection_EscapeCampSelection_Popup02_UIBP = {
    ...
    path = "/Game/Mod/Lobby/Split/ModeSelection/Popup/ModeSelection_EscapeCampSelection_Popup02_UIBP.ModeSelection_EscapeCampSelection_Popup02_UIBP",
    uiStat = {
  ...
  item_small_mode_selection_main = {
    ...
    moduleName = "client.slua.umg.ModeSelection.ModeSelection_Main_Map01_Item",
    path = "/Game/Mod/Lobby/Split/ModeSelection/Item/ModeSelection_Main_Map02_Item.ModeSelection_Main_Map02_Item",
    isSingleton = false,
    isWindowsOBHide = true,
  ...
  ModeSelection_Custom_Item_UIBP = {
    ...
    path = "/Game/Mod/Lobby/Split/ModeSelection/Item/ModeSelection_Custom_Item_UIBP.ModeSelection_Custom_Item_UIBP",
    isSingleton = false,
    isWindowsOBHide = true,
    uiStat = {
  ...
  ModeSelection_Custom_WowMap_Item = {
    ...
    path = "/Game/Mod/Lobby/Split/ModeSelection/Item/ModeSelection_Main_WowMap_Item_UIBP.ModeSelection_Main_WowMap_Item_UIBP",
    isSingleton = false,
    isWindowsOBHide = true,
    uiStat = {
  ...
  item_double_small_mode_selection_main = {
    ...
    path = "/Game/Mod/Lobby/Split/ModeSelection/Item/ModeSelection_Main_Map_Item.ModeSelection_Main_Map_Item",
    isSingleton = false,
    isWindowsOBHide = true,
    loadFromPool = EUIConfigPoolType.other_pool,
    uiStat = {
  ...
  item_multi_big_mode_selection_main = {
    ...
    path = "/Game/Mod/Lobby/Split/ModeSelection/Item/ModeSelection_Main_MultiMap01_Item.ModeSelection_Main_MultiMap01_Item",
    isSingleton = false,
    isWindowsOBHide = true,
    uiStat = {
  ...
  item_multi_small_mode_selection_main = {
    ...
    moduleName = "client.slua.umg.ModeSelection.ModeSelection_Main_MultiMap01_Item",
    path = "/Game/Mod/Lobby/Split/ModeSelection/Item/ModeSelection_Main_MultiMap02_Item.ModeSelection_Main_MultiMap02_Item",
    isSingleton = false,
    isWindowsOBHide = true,
    uiStat = {
  ...
  mode_selection_multi_popup = {
    ...
    path = "/Game/Mod/Lobby/Split/ModeSelection/ModeSelection_ArmsRaceMap_UIBP.ModeSelection_ArmsRaceMap_UIBP",
    uiStat = {
  ...
  ModeSelection_Guide_UIBP = {
    ...
    path = "/Game/Mod/Lobby/Split/ModeSelection/ModeSelection_Guide_UIBP.ModeSelection_Guide_UIBP",
    uiStat = {
  ...
  ModeSelection_Guide_UIBP02 = {
    ...
    path = "/Game/Mod/Lobby/Split/ModeSelection/Popup/ModeSelection_Guide_UIBP02.ModeSelection_Guide_UIBP02",
    uiStat = {
  ...
  mode_selection_filter = {
    ...
    path = "/Game/Mod/Lobby/Split/ModeSelection/Popup/ModeSelection_Main_Person_Tips.ModeSelection_Main_Person_Tips",
    uiStat = {
  ...
  ModeSelection_Popup_level_UIBP = {
    ...
    path = "/Game/Mod/Lobby/Split/ModeSelection/Popup/ModeSelection_Popup_level_UIBP.ModeSelection_Popup_level_UIBP",
    uiStat = {
  ...
  ModeSelection_Popup_Video_UIBP = {
    ...
    path = "/Game/Mod/Lobby/Split/ModeSelection/Popup/ModeSelection_Popup_Video_UIBP.ModeSelection_Popup_Video_UIBP",
    uiStat = {
  ...
  arena_main = {
    ...
    path = "/Game/Mod/Lobby/Split/ModeSelection/Match/match_Evolutionary_bp.match_Evolutionary_bp",
    uiStat = {
  ...
  arena_info = {
    ...
    path = "/Game/Mod/Lobby/Split/ModeSelection/Match/Match_Item/match_Evolutionary_item.match_Evolutionary_item",
    isSingleton = false,
    uiStat = {
  ...
  ModeSelection_Custom_UIBP = {
    ...
    path = "/Game/Mod/Lobby/Split/ModeSelection/ModeSelection_Custom_UIBP.ModeSelection_Custom_UIBP",
    zOrder = 0,
    uiStat = {
  ...
  ModeSelection_Select_UIBP = {
    ...
    path = "/Game/Mod/Lobby/Split/ModeSelection/ModeSelection_Select_UIBP.ModeSelection_Select_UIBP",
    zOrder = 0,
  ...
  ModeSelection_Wow_UIBP = {
    ...
    path = "/Game/Mod/Lobby/Split/ModeSelection/ModeSelection_Wow_UIBP.ModeSelection_Wow_UIBP",
  ...
  ModeSelection_Custom_Popup_UIBP = {
    ...
    path = "/Game/Mod/Lobby/Split/ModeSelection/Popup/ModeSelection_Custom_Popup_UIBP.ModeSelection_Custom_Popup_UIBP",
    uiStat = {
  ...
  ModeSelection_Custom_Popup_Wow_UIBP = {
    ...
    path = "/Game/Mod/Lobby/Split/ModeSelection/Popup/ModeSelection_Custom_Popup_Wow_UIBP.ModeSelection_Custom_Popup_Wow_UIBP",
    isSingleton = false,
    uiStat = {
  ...
  ModeSelection_Set_Item_UIBP = {
    ...
    path = "/Game/Mod/Lobby/Split/ModeSelection/ModeSelection_Set_Item_UIBP.ModeSelection_Set_Item_UIBP",
    isSingleton = false,
    uiStat = {
  ...
  ModeSelection_Opening_Train_UIBP = {
    ...
    path = "/Game/Mod/TPlan/XMission/UMG/ModeSelection_Opening_Train_UIBP.ModeSelection_Opening_Train_UIBP",
  ...
  ModeSelection_Map_Team_Item = {
    ...
    path = "/Game/Mod/Lobby/Split/ModeSelection/Item/ModeSelection_Map_Team_Item.ModeSelection_Map_Team_Item",
    isSingleton = false,
    isWindowsOBHide = true,
    uiStat = {
  ...
  newbie_mode_select = {
    ...
    path = "/Game/Mod/Lobby/Base/Newbie/Newbie_ModeSelect_UIBP.Newbie_ModeSelect_UIBP",
    AndroidBackType = EAndroidBackType.Ban
  },
  newbie_mode_select_entry = {
    keyName = "newbie_mode_select_entry",
    moduleName = "client.slua.umg.newbie.newbie_mode_select_entry",
    path = "/Game/Mod/Lobby/Base/Newbie/Newbie_ModeSelect_Entry_UIBP.Newbie_ModeSelect_Entry_UIBP",
    AndroidBackType = EAndroidBackType.Ban
  },
  arena_levelup = {
    moduleName = "client.slua.umg.arena.arena_levelup",
    path = "/Game/Mod/Lobby/Split/ModeSelection/Match/match_SeasonGet_UIBP.match_SeasonGet_UIBP",
    uiStat = {
