...
local login_ui_configs = {
  splash_screen = {
    ...
    path = "/Game/Mod/Lobby/Base/Login/Update/SplashScreen_UIBP.SplashScreen_UIBP",
  ...
  version_update = {
    ...
    path = "/Game/Mod/Lobby/Base/Login/Update/VersionUpdate_UIBP.VersionUpdate_UIBP",
    AndroidBackType = EAndroidBackType.Ban,
    uiStat = {
  ...
  Login_UIBP = {
    ...
    path = "/Game/Mod/Lobby/Base/Login/NewLogin_UIBP.NewLogin_UIBP",
  ...
  NewLogin_Tips_UIBP = {
    ...
    isMainUI = false,
    path = "/Game/Mod/Lobby/Base/Login/NewLogin_Tips_UIBP.NewLogin_Tips_UIBP",
    uiStat = {name = "\231\153\187\229\189\149tips"}
  },
  login_video = {
    keyName = "login_video",
    moduleName = "client.slua.umg.NewLogin.login_video",
    path = "/Game/Mod/Lobby/Base/Login/Login_Video_UIBP.Login_Video_UIBP",
    AndroidBackType = EAndroidBackType.Skip,
    uiStat = {
  ...
  login_background = {
    ...
    path = "/Game/Mod/Lobby/Base/Login/Login_Background_UIBP.Login_Background_UIBP",
    AndroidBackType = EAndroidBackType.Skip,
    uiStat = {
  ...
  login_forcerepair = {
    ...
    path = "/Game/Mod/Lobby/Base/Login/Login_ForceRepair_UIBP.Login_ForceRepair_UIBP",
    uiStat = {
  ...
  repair_forceconfirm = {
    ...
    path = "/Game/Mod/Lobby/Base/Login/Repair_ForceConfirm_UIBP.Repair_ForceConfirm_UIBP",
    uiStat = {
  ...
  ServerList_UIBP = {
    ...
    path = "/Game/Mod/Lobby/Base/Login/ServerList_UIBP.ServerList_UIBP",
    uiStat = {
  ...
  repair = {
    ...
    path = "/Game/Mod/Lobby/Base/Login/Login_Repair_UIBP.Login_Repair_UIBP",
    asy = true,
    uiStat = {
  ...
  Login_QRCode_Popup_UIBP = {
    ...
    path = "/Game/Mod/Lobby/Base/Login/Login_QRCode_Popup_UIBP.Login_QRCode_Popup_UIBP",
  ...
  login_no_auth = {
    ...
    path = "/Game/Mod/Lobby/Base/Login/Other/Item/Login_NoAuth_UIBP.Login_NoAuth_UIBP",
    uiStat = {
  ...
  login_choice = {
    ...
    path = "/Game/Mod/Lobby/Base/Login/Other/LoginChoice_PanelBP.LoginChoice_PanelBP",
    uiStat = {
  ...
  login_phone_mail = {
    ...
    path = "/Game/Mod/Lobby/Base/Login/Other/LoginChoice_phone_UIBP.LoginChoice_phone_UIBP",
    uiStat = {
  ...
  LoginFormMail_UIBP = {
    keyName = "LoginFormMail_UIBP",
    moduleName = "client.slua.umg.login.subform.LoginFormMail_UIBP",
    path = "/Game/Mod/Lobby/Base/Login/Other/SubForm/LoginFormMail_UIBP.LoginFormMail_UIBP",
    uiStat = {
      name = "\231\153\187\229\189\149-\233\130\174\231\174\177\231\153\187\229\189\149\229\173\144UI"
    },
    loadFromPool = EUIConfigPoolType.None
  },
  LoginFormPhone_UIBP = {
    keyName = "LoginFormPhone_UIBP",
    moduleName = "client.slua.umg.login.subform.LoginFormPhone_UIBP",
    path = "/Game/Mod/Lobby/Base/Login/Other/SubForm/LoginFormPhone_UIBP.LoginFormPhone_UIBP",
    uiStat = {
      name = "\231\153\187\229\189\149-\230\137\139\230\156\186\229\143\183\231\153\187\229\189\149\229\173\144UI"
    },
    loadFromPool = EUIConfigPoolType.None
  },
  LoginResetPass_UIBP = {
    keyName = "LoginResetPass_UIBP",
    moduleName = "client.slua.umg.login.subform.LoginResetPass_UIBP",
    path = "/Game/Mod/Lobby/Base/Login/Other/SubForm/LoginResetPass_UIBP.LoginResetPass_UIBP",
    uiStat = {
      name = "\231\153\187\229\189\149-\230\137\190\229\155\158\229\175\134\231\160\129\229\173\144UI"
    },
    loadFromPool = EUIConfigPoolType.None
  },
  login_verify_confirm = {
    ...
    path = "/Game/Mod/Lobby/Base/Login/Other/Login_Verify_Confirm_UIBP.Login_Verify_Confirm_UIBP",
    uiStat = {
  ...
  login_verify_code_box = {
    ...
    path = "/Game/Mod/Lobby/Base/Login/Other/Login_Verify_Code_Box_UIBP.Login_Verify_Code_Box_UIBP",
    uiStat = {
  ...
  login_scanlogin = {
    ...
    path = "/Game/Mod/Lobby/Base/Login/Other/Login_Scanlogin_UIBP.Login_Scanlogin_UIBP",
    uiStat = {
  ...
  Protection_UIBP = {
    ...
    path = "/Game/Mod/Lobby/Base/Login/Protection_UIBP.Protection_UIBP",
    uiStat = {
  ...
  LoginPunchInAct = {
    ...
    path = "/Game/Mod/Lobby/Split/NewActivity/UMG/UI_BP/Avtivity_WeekSign/LoginPunchInAct_UIBP.LoginPunchInAct_UIBP",
    isMainUI = false,
    uiStat = {
  ...
  LoginPhoneBH_UIBP = {
    ...
    path = "/Game/Mod/Lobby/Base/Login/LoginPhoneBH_UIBP.LoginPhoneBH_UIBP",
    uiStat = {
  ...
  FaceTeam_UIBP = {
    ...
    path = "/Game/Mod/Lobby/Split/Friend/UI_BP/Faceteam_UIBP.Faceteam_UIBP",
    uiStat = {
  ...
  FaceTeamEnter_UIBP = {
    ...
    path = "/Game/Mod/Lobby/Split/Friend/UI_BP/Faceteam_UIPB2.Faceteam_UIPB2",
    uiStat = {
