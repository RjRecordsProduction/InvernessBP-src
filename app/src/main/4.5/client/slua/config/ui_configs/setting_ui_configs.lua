...
local setting_ui_configs = {
  ...
  SettingShare_Popup_UIBP = {
    keyName = "SettingShare_Popup_UIBP",
    moduleName = "client.slua.umg.setting.SettingShare_Popup_UIBP",
    path = "/Game/UMG/UI_BP/Setting/Popup/SettingShare_Popup_UIBP.SettingShare_Popup_UIBP",
    asy = true,
    loadFromPool = EUIConfigPoolType.None,
    uiStat = {
      name = "SettingShare_Popup_UIBP"
    }
  },
  ...
  setting_account_spare_code = {
    ...
    path = "/Game/Mod/Lobby/Base/Login/Other/Login_Verify_safely_Confirm_UIBP.Login_Verify_safely_Confirm_UIBP",
    asy = true,
    uiStat = {
  ...
  WBP_Setting_Page_Layout_Special_Maincity = {
    keyName = "WBP_Setting_Page_Layout_Special_Maincity",
    moduleName = "client.slua.umg.Setting25.Page.WBP_Setting_Page_Layout_Special_Maincity",
    path = "/Game/UMG/UI_BP/Setting25/Page/WBP_Setting_Page_Layout_Special_Maincity.WBP_Setting_Page_Layout_Special_Maincity",
    isMainUI = false,
    uiStat = {
      name = "\228\184\187\229\159\142\232\135\170\229\174\154\228\185\137\233\148\174\228\189\141"
    }
  },
  ...
  WBP_Setting_Pet_Popup_UIBP = {
    keyName = "WBP_Setting_Pet_Popup_UIBP",
    moduleName = "client.slua.umg.Setting25.Popup.WBP_Setting_Pet_Popup_UIBP",
    path = "/Game/UMG/UI_BP/Setting25/Popup/WBP_Setting_Pet_Popup_UIBP.WBP_Setting_Pet_Popup_UIBP"
  }
}
