...
function logic_puffer_common._GetKickOutList()
  ...
  USFSKickoutPkgName = USFSKickoutPkgName .. ",/Game/UMG/UI_Effect/Textures/dating/t_mask_mohu_Train01"
  USFSKickoutPkgName = USFSKickoutPkgName .. ",/Game/Library/Res/Skills/PSKillSprint/Arts/UI/Icon/ZD_Icon_Specialization03"
...
function logic_puffer_common.USFCacheInitProcess()
  ...
  if CacheSysContextStartSwitch == 1 and Client.GetAndroidSOVersion() ~= 32 and Client.GetMemorySize() >= 4 then
    ...
    local USFCSCEnhancedLockGuard = HDmpveRemote.HDmpveRemoteConfigGetInt("USFCSCEnhancedLockGuard", 0)
    log_format("logic_puffer_common.USFCacheInitProcess r.CSCEnhancedLockGuard: %s", USFCSCEnhancedLockGuard)
    gameInstance:ExecuteCMD("r.CSCEnhancedLockGuard", USFCSCEnhancedLockGuard)
