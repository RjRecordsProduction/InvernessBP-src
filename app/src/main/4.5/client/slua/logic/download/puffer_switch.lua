...
local _bIsShowedAutoDevTip = false
if IsWoWEditor then
...
function PufferSwitch.InitAutoDownloadSwitch()
  ...
  elseif autoDownloadCfg.RecommendType == PufferConst.Enum_RecommendType.FIT then
    autoDownloadCfg.RecommendType = PufferConst.Enum_RecommendType.None
  end
...
function PufferSwitch.InitAutoDownloadPrefetchSwitch()
  ...
  if PublishRegionMacros.IsFITVersion() then
    PufferSwitch.AutoDownloadPrefetchSwitch = false
    log(bWriteLog and "PufferSwitch.InitAutoDownloadPrefetchSwitch. FIT version, force close prefetch switch")
    return
  end
...
function PufferSwitch.CanAutoDownload()
  if Client.GetDeviceFreeSpace() < 10000 then
    if Client.IsDevelopment() and not _bIsShowedAutoDevTip then
      ShowDevNotice("###DevTip: \229\189\147\229\137\141\232\174\190\229\164\135\229\173\152\229\130\168\231\169\186\233\151\180 < 10GB \228\184\141\232\135\170\229\138\168\228\184\139\232\189\189")
      _bIsShowedAutoDevTip = true
    end
    return false
  end
