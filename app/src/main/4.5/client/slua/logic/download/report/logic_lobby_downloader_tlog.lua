...
function logic_lobby_downloader_tlog.ReportSelectSmartDownloadPlan(isMemoryPlan, MemoryPlanEnable)
  local plane = isMemoryPlan and "memory" or "custom"
...
function logic_lobby_downloader_tlog.ReportResourceSnapShot(curPaksSize)
