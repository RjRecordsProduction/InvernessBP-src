  ...
  for k, v in pairs(xMission_macro.Enum_Slot) do
    ...
    if not onlyPuton or info then
      ...
      if slotID then
        ...
        local bHideLobbyMetroFashion = SettingModule:GetOptionValue("MetroFashionLobbySwitcher")
...
function LogicTxMissionTeam._RestoreMeleeLobbyHold()
  local PlayerPrefsSystem = require("client.logic.LogicPlayerPrefs.playerprefs")
  local saveData = PlayerPrefsSystem.LoadFileToTable_N(PlayerPrefsSystem.ePlayerPrefsType.eXmissionMeleeLobbyHold)
  if saveData and saveData.bHold then
    LogicTxMissionTeam.bMeleeLobbyHold = true
    LogicTxMissionTeam.nMeleeLobbyHoldInsId = saveData.insId
    printf("[xmission] _RestoreMeleeLobbyHold - restored bHold=true, insId=%s", tostring(saveData.insId))
  else
    LogicTxMissionTeam.bMeleeLobbyHold = false
    LogicTxMissionTeam.nMeleeLobbyHoldInsId = nil
  end
end
