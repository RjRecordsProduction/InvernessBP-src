...
function logic_newbie_reward_eight_day.ShowUI()
  ...
  logic_newbie_activity.ShowUIWithModCheck(UIManager.UI_Config.Flap_Newbie_Reward_Eight_Days)
end
...
function logic_newbie_reward_eight_day.IsShowNewbieRewardEightDaySlap()
  ...
  if not NewbieActivitySystem.IsModReady() then
    log_warning(bWriteLog and "logic_newbie_reward_eight_day.IsShowNewbieRewardEightDaySlap - not IsModReady")
    return false
  end
  if not logic_newbie_reward_eight_day.IsOpen() then
    return false
