...
function logic_mode_utils.IsNarutoView(viewId)
  local narutoViewIds = {
    [90155] = true,
    [90159] = true,
    [90162] = true,
  ...
  return narutoViewIds[viewId]
end
function logic_mode_utils.GetNarutoBgPath()
  return "/Game/UMG/Texture/Lobby_NoAtlas/Lobby_Match_SelectMap/ModeSelection_New/BG/ModeSelection_Image_BG11.ModeSelection_Image_BG11"
end
function logic_mode_utils.GetSubwayBgPath()
  return "/Game/Mod/Lobby/Split/MatchSelectMap/450/ModeSelection_New/BG/ModeSelection_Image_BGNT.ModeSelection_Image_BGNT"
end
function logic_mode_utils.ShouldShowNarutoBg(viewInfo, isSelectTheme)
  if not viewInfo or not isSelectTheme then
    return false
  end
  return logic_mode_utils.IsNarutoView(viewInfo.id)
end
