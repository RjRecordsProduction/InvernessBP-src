...
Return_Activity_Macro.local ReturnFrontTLog = {
  OpenSource = {ModeSelectPopup = 1, LoginPopup = 2}
}
...
local MenuEntranceInfoList = {
  ...
  [Enum_MenuID.Discount] = {
    uiConfig = UIManager.UI_Config.ReturnActivity_SpeciallyPreferential_UIBP_01,
  ...
  [Enum_MenuID.AssemblyTeamUp] = {
    uiConfig = UIManager.UI_Config.Assembly_TeamUp_UIBP,
    title = 7656008,
    icon_url = "/Game/UMG/Texture/Lobby_NoAtlas/COMEBACK/ReturnActivity/ReturnActivity_Bg103.ReturnActivity_Bg103"
  }
}
