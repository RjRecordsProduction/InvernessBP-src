...
function logic_home_car_parking:proc_manor_parking_currency_rsp(currency)
  ...
  local logic_home_parking_coin_alert = ModuleManager.GetModule(ModuleManager.CommonModuleConfig.logic_home_parking_coin_alert)
  logic_home_parking_coin_alert:TryShowAlert()
end
