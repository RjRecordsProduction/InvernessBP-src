local logic_chat_voice_const = {
  ...
  Enum_InvokeCmd = {
    ...
    GV_ASR_OPT = 8621,
    GV_ASR_OPT_8592 = 8592,
    GV_DENOISE_MODEL_ENABLE = 10031,
    GV_ONWAKEUP_IMMEDIATE_CALLBACK = 9839
  },
  ...
  UploadFileSence = {SST = "f=stt", SocialCard = "SocialCard"},
  Enum_AndroidPermissionName = {
    RecordAudio = "[android.permission.RECORD_AUDIO]"
  },
  Enum_AndroidPermissionResult = {Granted = "[0]", Denied = "[-1]"}
}
