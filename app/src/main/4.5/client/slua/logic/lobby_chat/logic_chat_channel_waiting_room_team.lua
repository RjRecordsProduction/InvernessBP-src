...
local logic_chat_channel_waiting_room_team = {}
...
function logic_chat_channel_waiting_room_team.ClearData()
  chatMessageList:ClearData()
end
function logic_chat_channel_waiting_room_team.AddNewChat(chatMsg)
...
function logic_chat_channel_waiting_room_team.GetMessageList()
  return chatMessageList
end
function logic_chat_channel_waiting_room_team.SendMsg(content)
  local msg = {}
  msg.voice = ""
  msg.text = content
  msg.voiceLength = 0
  ...
  ChatHandler.send_chat_req(0, chat_macro.Channel.WaitingRoomTeam, msgId, msg)
end
function logic_chat_channel_waiting_room_team.SendVoiceMsg(voiceId, length, content)
...
function logic_chat_channel_waiting_room_team.ClearSomesMsg(uid)
...
return logic_chat_channel_waiting_room_team