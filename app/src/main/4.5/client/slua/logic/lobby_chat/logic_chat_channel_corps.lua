...
function logic_chat_channel_corps.AddOfflineCorpsChatMsg(corpsData)
  ...
  if corpsData == nil or corpsData.chat_data == nil and corpsData.pdd_data == nil and corpsData.rp_groupbuy_data == nil and corpsData.new_group_buy_data == nil and corpsData.new_bargain_data == nil then
    return
  end
  logic_chat_channel_corps.offlineChatMsgBuffer = {}
  ...
  logic_chat_channel_corps.RPGroupBuyMsg(corpsData.new_bargain_data)
