  ...
  if UGCModID == nil then
    ...
    if UGCMapID ~= nil and ResList ~= nil then
      ...
      if DownloadSuccess == true then
        ...
        local ResIdList = LogicUGCResManager:GetDependIdsByIntMap(ResList)
...
function logic_replay.ShowWonderfulReplaySwitchTip()
  ...
  local WonderfulReplaySwitch = SettingModule:GetOptionValue("bRecordWonderfulReplayOpen")
  ...
  local jumpBtn = {
    callback = function()
      ...
      SettingUtil.Enter("Game", "Game_Advanced", "bRecordWonderfulReplayOpen")
