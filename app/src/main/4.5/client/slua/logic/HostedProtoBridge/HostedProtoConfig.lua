...
HostedProtoConfig.Proto = {
  ...
  ModifyPufferDownloadLimit = {
    modulePath = "CommonModuleConfig",
    moduleName = "HostedCommonProtocol",
    func = "ModifyPufferDownloadLimit"
  },
  DownloadWoWMap = {
    modulePath = "CommonModuleConfig",
    moduleName = "HostedCommonProtocol",
  ...
  UpdateAnonymous = {
    modulePath = "CommonModuleConfig",
    moduleName = "PatrollerModule",
    func = "UpdateAnonymous"
  },
  QueryAnonymous = {
    modulePath = "CommonModuleConfig",
    moduleName = "PatrollerModule",
  ...
  pandoraAppStartDownload = {
    modulePath = "CommonModuleConfig",
    moduleName = "GameletResMonitor",
    func = "pandoraAppStartDownload",
    AllowHighFreq = true
  },
  pandoraAppDownloadComplete = {
    modulePath = "CommonModuleConfig",
    moduleName = "GameletResMonitor",
    func = "pandoraAppDownloadComplete",
    AllowHighFreq = true
  },
  QueryCorpsConfig = {
    modulePath = "CommonModuleConfig",
    moduleName = "HostedCommonProtocol",
    func = "QueryCorpsConfig",
    Static = true
  }
}
