...
function logic_corps_fight.ShowRightTipUI()
  if not logic_corps_fight.GetSubscribeState() then
    log(bWriteLog and "logic_corps_fight.ShowRightTipUI not Subscribe")
    return
  end
...
function logic_corps_fight.ShowScoreTip()
  ...
  log(bWriteLog and "logic_corps_fight.ShowScoreTip ShowFightTip:" .. tostring(logic_corps_fight.ShowFightTip))
...
function logic_corps_fight.GetSubscribeState()
  local playerPrefsSystem = require("client.logic.LogicPlayerPrefs.playerprefs")
  local showCfg = playerPrefsSystem.LoadFileToTable_N(playerPrefsSystem.ePlayerPrefsType.CorpsSubscribeState)
  local subscribeState = showCfg and showCfg.Subscribed
  log(bWriteLog and "logic_corps_fight.GetSubscribeState:" .. tostring(subscribeState))
  return subscribeState
end
function logic_corps_fight.SetSubscribeState(hasSubscribed)
  log(bWriteLog and "logic_corps_fight.SetSubscribeState:" .. tostring(hasSubscribed))
  local playerPrefsSystem = require("client.logic.LogicPlayerPrefs.playerprefs")
  local showCfg = playerPrefsSystem.LoadFileToTable_N(playerPrefsSystem.ePlayerPrefsType.CorpsSubscribeState)
  showCfg = showCfg or {}
  showCfg.Subscribed = hasSubscribed
  playerPrefsSystem.SaveTableToFile_N(showCfg, playerPrefsSystem.ePlayerPrefsType.CorpsSubscribeState)
end
