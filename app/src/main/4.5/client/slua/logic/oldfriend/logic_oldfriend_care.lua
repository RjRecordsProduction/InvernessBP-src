...
function logic_oldfriend_care.InitData(data, para)
  ...
  AssemblyActivitySystem.weekly_score_count = data.weekly_score_count or 0
  AssemblyActivitySystem.score_flow = data.score_flow or {}
  log(bWriteLog and string.format("logic_oldfriend_care.InitData, rejoin_care_count:%s, battle_score_count:%s, weekly_score_count:%s", tostring(AssemblyActivitySystem.rejoin_care_count), tostring(AssemblyActivitySystem.battle_score_count), tostring(AssemblyActivitySystem.weekly_score_count)))
