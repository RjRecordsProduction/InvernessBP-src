...
function treasure_chest_manager:CheckIsOwnedOfItem(cfg, data)
  ...
  local isHave = wardrobe_data:GetHallDepotItemDataByResID(data.DropItemID) ~= nil or logic_pet:HasPetPermanently(data.DropItemID) or logic_pet:HasPetDressPermanently(data.DropItemID) or ItemUpgradeMgr:IsUnlockWeapon(data.DropItemID)
