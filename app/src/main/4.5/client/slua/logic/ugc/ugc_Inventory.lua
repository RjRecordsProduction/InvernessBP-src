...
UGC_Inventory.InventoryList = {
  [1] = {
    ...
    [1] = {
      ...
      path = "/Game/Mod/Lobby/Split/WoW/Store/UGC_KillEffect_UIBP.UGC_KillEffect_UIBP",
  ...
  [2] = {
    ...
    [1] = {
      ...
      path = "/Game/Mod/Lobby/Split/WoW/Store/UGC_InformationCard_UIBP.UGC_InformationCard_UIBP",
    ...
    [3] = {
      SubTabID = 30104,
      NormalIcon = "/Game/UMG/Texture_200/Atlas/CreativeMode/Frames/Common_Tab_CommentSkin_png.Common_Tab_CommentSkin_png",
      SelectIcon = "/Game/UMG/Texture_200/Atlas/CreativeMode/Frames/Common_Tab_CommentSkin_Select_png.Common_Tab_CommentSkin_Select_png",
      moduleName = "client.slua.umg.ugc.lobby.UGCInventory.UGC_PlayerComment_UIBP",
      path = "/Game/Mod/Lobby/Split/WoW/Store/UGC_InformationCard_UIBP.UGC_InformationCard_UIBP",
      DataName = UGC_Inventory.DataNameList.Dress_PlayerComment,
      config = config_InventoryList
    }
  }
}
