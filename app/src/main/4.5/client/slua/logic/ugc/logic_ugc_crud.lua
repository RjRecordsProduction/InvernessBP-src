...
function LogicUGCCRUD:SetExposureCouponState(state)
  log(bWriteLog and "LogicUGCCRUD:SetExposureCouponState: state = " .. tostring(state))
  self.ExposureCouponState = state
end
function LogicUGCCRUD:GetExposureCouponState()
  return self.ExposureCouponState
end
