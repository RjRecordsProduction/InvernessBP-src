...
function UGCPlayHallRoom:OnShowRoomUI(_, _, From)
  log_format("UGCPlayHallRoom:OnShowRoomUI. From=%s", From)
...
function UGCPlayHallRoom:GetPendingMatchModID()
  if not self.bInPendingMatchState then
    return nil
  end
  if self.PendingMatchParamRecord then
    return self.PendingMatchParamRecord.ModID
  elseif self.PendingPlayHallParamRecord then
    return self.PendingPlayHallParamRecord.ModID
  elseif self.LastJoinModID then
    return self.LastJoinModID
  end
  return nil
end
