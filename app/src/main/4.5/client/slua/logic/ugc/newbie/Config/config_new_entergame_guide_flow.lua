      ...
      if logic_ugc_new_process:CheckIsOpen() then
        ...
        if curPage == ENUM_LobbyPageType.Right then
          if logic_ugc_newbie_guide and logic_ugc_newbie_guide:IsEnterWOWHallNewbieGuideOn() then
            print(bWriteLog and "Config_UGC.Newbie_Guide_Type_Key.UGCOpenTitleIntroduction Right IsEnterWOWHallNewbieGuideOn is true")
            return true
          end
          print(bWriteLog and "Config_UGC.Newbie_Guide_Type_Key.UGCOpenTitleIntroduction Right IsEnterWOWHallNewbieGuideOn is false")
          return false
        end
      end
      if logic_ugc_newbie_guide and logic_ugc_newbie_guide:IsEnterGameUGCNewbieGuideOn() then
        print(bWriteLog and "Config_UGC.Newbie_Guide_Type_Key.UGCOpenTitleIntroduction IsEnterWOWHallNewbieGuideOn is true")
        return true
      end
      print(bWriteLog and "Config_UGC.Newbie_Guide_Type_Key.UGCOpenTitleIntroduction IsEnterWOWHallNewbieGuideOn is false")
      return false
    end,
