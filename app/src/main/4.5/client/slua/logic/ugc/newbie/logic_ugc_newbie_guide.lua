...
function LogicUGCNewbie:OnInitialize()
  self:InitNewbieGuideData()
end
function LogicUGCNewbie:InitNewbieGuideData()
...
function LogicUGCNewbie:OnLogOut()
  print(bWriteLog and "LogicUGCNewbie:OnLogOut")
  self:ClearNewbieGuide()
end
function LogicUGCNewbie:OnPostSwitchGameStatus(preState, nextState)
  print(bWriteLog and "LogicUGCNewbie:OnPostSwitchGameStatus preState:" .. tostring(preState) .. " nextState:" .. tostring(nextState))
...
function LogicUGCNewbie:ClearNewbieGuide()
  print(bWriteLog and "LogicUGCNewbie:ClearNewbieGuide")
