...
function logic_weapon_strength:proc_get_weapon_power_data_rsp(cur_weapon_power_data, history_weapon_power_data)
  ...
  if profile and profile.weapon_power_data then
    ...
    log(bWriteLog and "logic_weapon_strength:proc_get_weapon_power_data_rsp profile.weapon_power_data is nil")
    ...
    end, Enum_PROFILE_REPORT_CFG.ROLE_INFO, 10000, false)
  end
end
