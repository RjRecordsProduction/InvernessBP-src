...
local LadderDrawSystem = {
  defaultShowingUIKey = "ferrari_car_main",
  svrDrawData = {},
  svrRandomAwardData = {},
  ...
  CONST = {
    ...
    E_UICfg = {
      ...
      ferrari_car_main = "client.slua.umg.lobby_activity.SportsCarSpin.4500.SportsCar4500_UIConfig"
    },
    E_StoreUIToCarUICfg = {
      porsche_car_store_4100 = "porsche_car_main",
      apollo_car_store_4300 = "apollo_car_main",
      ferrari_car_store_4500 = "ferrari_car_main"
    },
