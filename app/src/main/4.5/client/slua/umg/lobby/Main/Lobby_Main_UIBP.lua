...
function Lobby_Main_UIBP:OnSwitchToPageEndEvent(_, _, nFormPage, nTargetPage)
  if nFormPage == ENUM_LobbyPageType.Left then
    ...
    local Logic_PlanCH_GuideManager = require("client.slua.logic.lobby.Left.SocialLobby.Logic_PlanCH_GuideManager")
    Logic_PlanCH_GuideManager:HideAllGuides()
  end
end
...
function Lobby_Main_UIBP:UpdateLobbySkin(eventType, eventID, skinId)
  ...
  if not downloaded then
    ...
    self.curSkinPath = "/Game/Mod/Lobby/Split/ModeSelection/NoAtlas/ModeSelection_New/BG/ModeCustom_Image_BG.ModeCustom_Image_BG"
  end
...
function Lobby_Main_UIBP:ChangeRightModeBg()
  self:SetTexture(self.UIRoot.Image_1, "/Game/Mod/Lobby/Split/ModeSelection/NoAtlas/ModeSelection_New/BG/ModeCustom_Image_BG.ModeCustom_Image_BG")
end
