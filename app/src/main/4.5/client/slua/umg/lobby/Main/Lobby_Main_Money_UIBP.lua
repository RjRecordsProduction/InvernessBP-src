...
function Lobby_Main_Money_UIBP:UpdateVersionImage()
  local UnknowPassUtil = require("client.slua.logic.unknow_pass.logic_unknowpass_util")
  local version = UnknowPassUtil.GetVersionNumber()
  self:SetTexture(self.UIRoot.Image_NewSeasonRecharge, "/Game/Mod/Lobby/Split/NewSeason/Season/" .. version .. "/FirstCharge/Lobby_InitialCharge_BG.Lobby_InitialCharge_BG")
  self:SetTexture(self.UIRoot.Image_10, "/Game/Mod/Lobby/Split/NewSeason/Season/" .. version .. "/FirstCharge/Lobby_InitialCharge_BG01.Lobby_InitialCharge_BG01")
end
