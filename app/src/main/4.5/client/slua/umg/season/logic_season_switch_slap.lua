...
function logic_season_switch_slap:GMResetSeasonSwitchSlap()
  log_warning("logic_season_switch_slap:GMResetSeasonSwitchSlap. season_id = " .. tostring(DataMgr.season_id))
  local LogicNewbie = require("client.logic.newbie.logic_newbie")
  DataMgr.SetNewbieGuideValue(LogicNewbie.NEWBIE_GUIDE_MODULE_ID_SEASON_SWITCH_SLAP, DataMgr.season_id, 0)
  if self._saveData then
    self._saveData.hasShow = false
