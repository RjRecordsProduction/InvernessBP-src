...
local chat_ui_config = {
  channel = {
    [macro.Channel.channelSocialIslandChat] = {
      ...
      tabDefaultIcon = "/Game/UMG/Texture_200/Atlas/LobbyChatUI/Frames/Common_Tab_SocialIsland_png.Common_Tab_SocialIsland_png",
    ...
    [macro.Channel.channelGlobalManor] = {
      ...
      tabDefaultIcon = "/Game/UMG/Texture_200/Atlas/LobbyChatUI/Frames/Common_Tab_Home_World_png.Common_Tab_Home_World_png",
      checkShowFunc = function()
        local logic_home_switch = ModuleManager.GetModule(ModuleManager.LobbyModuleConfig.logic_home_switch)
        if not logic_home_switch:CheckHomeSwitchOpen() or GameStatus.IsCollectionHallMode() then
          return false
        end
    ...
    [macro.Channel.channelCurrentManor] = {
      ...
      tabDefaultIcon = "/Game/UMG/Texture_200/Atlas/LobbyChatUI/Frames/Common_Tab_Home_Room__png.Common_Tab_Home_Room__png",
      checkShowFunc = function()
    ...
    [macro.Channel.channelGlobalPlanCH] = {
      tabId = 2,
      channelModuleName = "client.slua.umg.lobby_chat.planCH.Chat_PlanCHGlobalChannel_UIBP",
      channelBpPath = macro.path.Chat_PlanCHGlobalChannel_UIBP,
      channelId = macro.Channel.channelGlobalPlanCH,
      uiStat_name = "\232\129\138\229\164\169\233\162\145\233\129\147-\231\143\141\232\151\143\233\166\134\228\184\150\231\149\140",
      margin = FMargin(72, 0, 0, 10),
      tabSelectIcon = "/Game/UMG/Texture_200/Atlas/LobbyChatUI/Frames/Common_Tab_ExhibitionHall_World_Xuanzhong_png.Common_Tab_ExhibitionHall_World_Xuanzhong_png",
      tabDefaultIcon = "/Game/UMG/Texture_200/Atlas/LobbyChatUI/Frames/Common_Tab_ExhibitionHall_World_png.Common_Tab_ExhibitionHall_World_png",
      checkShowFunc = function()
        return GameStatus.IsCollectionHallMode()
      end
    },
    [macro.Channel.channelCurPlanCH] = {
      tabId = 3,
      channelModuleName = "client.slua.umg.lobby_chat.planCH.Chat_PlanCHCurChannel_UIBP",
      channelBpPath = macro.path.Chat_PlanCHCurChannel_UIBP,
      memberListBpPath = macro.path.ChatMemberList,
      memberListModuleName = "client.slua.umg.lobby_chat.planCH.Chat_PlanCHChatMemberList_UIBP",
      memberListAttachRoot = "islandMemberList",
      channelId = macro.Channel.channelCurPlanCH,
      uiStat_name = "\232\129\138\229\164\169\233\162\145\233\129\147-\229\189\147\229\137\141\231\143\141\232\151\143\233\166\134",
      margin = FMargin(320, 0, 0, 10),
      tabSelectIcon = "/Game/UMG/Texture_200/Atlas/LobbyChatUI/Frames/Common_Tab_ExhibitionHall_Current_Xuanzhong_png.Common_Tab_ExhibitionHall_Current_Xuanzhong_png",
      tabDefaultIcon = "/Game/UMG/Texture_200/Atlas/LobbyChatUI/Frames/Common_Tab_ExhibitionHall_Current_png.Common_Tab_ExhibitionHall_Current_png",
      checkShowFunc = function()
        return GameStatus.IsCollectionHallMode()
      end
    },
    [macro.Channel.channelWorld] = {
      ...
      tabDefaultIcon = "/Game/UMG/Texture_200/Atlas/LobbyChatUI/Frames/Common_Tab_World_png.Common_Tab_World_png",
      checkShowFunc = function()
        ...
        elseif GameStatus.IsInFightingStatus() then
          ...
          if bPlanPHMode or GameStatus.IsCollectionHallMode() then
            log(bWriteLog and "chat_ui_config.checkShowFunc world show false home or collection hall")
            return false
          end
          return true
        else
          local gameStatus = GameStatus.GetGameStatus()
          if gameStatus == GameStatus.Loading then
            return false
          end
          ...
          local PlanPH_GamePlay_Tools = require("GameLua.Mod.PlanPH.Tools.PlanPH_GamePlay_Tools")
          local bPlanPHMode = PlanPH_GamePlay_Tools.IsPHomeMode()
          local fmt = string.format("chat_ui_config.checkShowFuncNewReport. GameStatus:%s, lastGameStatus:%s, bSocialislandMode:%s, bPlanPHMode:%s\239\188\140traceback:%s", gameStatus, lastGameStatus, bSocialislandMode, bPlanPHMode, debug.traceback())
    ...
    [macro.Channel.WaitingRoom] = {
      ...
      tabDefaultIcon = "/Game/UMG/Texture_200/Atlas/LobbyChatUI/Frames/Common_Tab_Home_png.Common_Tab_Home_png",
      checkShowFunc = function()
        local logic_mode_mgr = require("client.slua.logic.match.logic_mode_mgr")
        ...
        local bPlanPHMode = PlanPH_GamePlay_Tools.IsPHomeMode()
        if bPlanPHMode or GameStatus.IsCollectionHallMode() then
          printf("chat_ui_config.checkShowFunc WaitingRoom show false. IsPHomeMode or CollectionHallMode")
          return false
        end
    ...
    [macro.Channel.channelTeamRecruit] = {
      ...
      tabDefaultIcon = "/Game/UMG/Texture_200/Atlas/LobbyChatUI/Frames/Common_Tab_Team_png.Common_Tab_Team_png",
      ...
      checkShowFunc = function()
        ...
        if not LogicPufferBundle.IsFitLobbyResDownloaded() then
          log(bWriteLog and "chat_ui_config.checkShowFunc channelTeamRecruit show false. FitLobbyRes not downloaded")
          return false
        end
    ...
    [macro.Channel.channelPrivate] = {
      ...
      tabDefaultIcon = "/Game/UMG/Texture_200/Atlas/LobbyChatUI/Frames/Common_Tab_Friend_png.Common_Tab_Friend_png"
    },
    [macro.Channel.channelTeam] = {
      ...
      tabDefaultIcon = "/Game/UMG/Texture_200/Atlas/LobbyChatUI/Frames/Common_Tab_3P_Team_png.Common_Tab_3P_Team_png",
      checkShowFunc = function()
        ...
        local bPlanPHMode = PlanPH_GamePlay_Tools.IsPHomeMode()
        if bPlanPHMode or GameStatus.IsCollectionHallMode() then
          printf("chat_ui_config.checkShowFunc channelTeam show false. IsPHomeMode or IsCollectionHallMode")
          return false
        end
        return true
      end
    ...
    [macro.Channel.channelCorps] = {
      ...
      tabDefaultIcon = "/Game/UMG/Texture_200/Atlas/LobbyChatUI/Frames/Common_Tab_Crops_png.Common_Tab_Crops_png",
      checkShowFunc = function()
        local LogicPufferBundle = require("client.slua.logic.download.bundle.logic_puffer_bundle")
        if not LogicPufferBundle.IsFitLobbyResDownloaded() then
          log(bWriteLog and "chat_ui_config.checkShowFunc channelCorps show false. FitLobbyRes not downloaded")
          return false
        end
    ...
    [macro.Channel.channelClub] = {
      ...
      tabDefaultIcon = "/Game/UMG/Texture_200/Atlas/LobbyChatUI/Frames/Common_Tab_Club_png.Common_Tab_Club_png",
      checkShowFunc = function()
    ...
    [macro.Channel.channelChatRoom] = {
      ...
      tabDefaultIcon = "/Game/UMG/Texture_200/Atlas/LobbyChatUI/Frames/Common_Tab_Room_png.Common_Tab_Room_png",
      checkShowFunc = function()
        local LogicTxMissionMain = require("client.slua.logic.TxMission.logic_xmission_main")
        if LogicTxMissionMain.IsInXMission() then
    ...
    [macro.Channel.channelFlashMatchTeam] = {
      ...
      tabDefaultIcon = "/Game/UMG/Texture_200/Atlas/LobbyChatUI/Frames/Common_Tab_TeamQuick_png.Common_Tab_TeamQuick_png",
      checkShowFunc = function()
