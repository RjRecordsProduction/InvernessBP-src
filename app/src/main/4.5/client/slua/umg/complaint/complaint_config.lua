...
local ComplaintConfig = {
  ...
  EComplaintSceneTLogType = {
    ...
    TeamQuick = 46,
    UGCStaticMeshReport = 47,
    PublicScreenVoiceReport = 50,
    GlobalVoiceReport = 51
  },
  EReportCamp = {
    Teammate = 1,
    Enemy = 2,
    AllIncludeTeammate = 3,
    AllExcludeTeammate = 4
  },
  EComplaintAIType = {
    BehaviorTree = 1,
    MachineLearning = 2,
...
local EReasonType = {
  ...
  UGCStaticMeshText = "UGCStaticMeshText",
  UGCStaticMeshContent = "UGCStaticMeshContent",
  UGCMapLobby = "UGCMapLobby",
  TeamQuick = "TeamQuick",
  UGCOriginModReport = "WoWEditorOriginModReport"
}
...
EComplaintUI[EComplaintModule.PlanBT] = {
  sUIName = "ui_complaint_planbt",
  sReasonType = EReasonType.Default,
  nNumSelectedReasonMax = 3
}
