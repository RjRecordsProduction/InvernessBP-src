...
VehicleSystem_Main_Show_Config.Vehicle_Process_Config = {
  {
    FeatureType = VehicleSystem_Main_Show_Config.ENUM_Vehicle_ExtendedFeatureType.VEHICLE_WHEEL_HUB,
    CheckShowFunc = "CheckShowWheelHubTab",
    OnSelected = "OnSelectedWheelHubTab",
    OnItemRefresh = "OnExtendedFeatureItemRefresh",
    OnselectItem = "OnSelectExtendedFeatureItem",
    OnDeselected = "OnDeselectedWheelHubTab",
    activePath = "/Game/UMG/Texture_200/Atlas/LobbyVehicle_Atlas/Frames/VehicleTab_WheelHub_01_png.VehicleTab_WheelHub_01_png",
    inactivePath = "/Game/UMG/Texture_200/Atlas/LobbyVehicle_Atlas/Frames/VehicleTab_WheelHub_01_png.VehicleTab_WheelHub_01_png"
  },
  {
    FeatureType = VehicleSystem_Main_Show_Config.ENUM_Vehicle_ExtendedFeatureType.VEHICLE_BRAKE_CALIPER,
    CheckShowFunc = "CheckShowBrakeCaliperTab",
    OnSelected = "OnSelectedBrakeCaliperTab",
    OnItemRefresh = "OnExtendedFeatureItemRefresh",
    OnselectItem = "OnSelectExtendedFeatureItem",
    OnDeselected = "OnDeselectedBrakeCaliperTab",
    activePath = "/Game/UMG/Texture_200/Atlas/LobbyVehicle_Atlas/Frames/VehicleTab_Caliper_01_png.VehicleTab_Caliper_01_png",
    inactivePath = "/Game/UMG/Texture_200/Atlas/LobbyVehicle_Atlas/Frames/VehicleTab_Caliper_01_png.VehicleTab_Caliper_01_png"
  },
  {
    FeatureType = VehicleSystem_Main_Show_Config.ENUM_Vehicle_ExtendedFeatureType.VEHICLE_CANOPY,
    CheckShowFunc = "CheckShowCanopyTab",
    OnSelected = "OnSelectedCanopyTab",
    OnItemRefresh = "OnExtendedFeatureItemRefresh",
    OnselectItem = "OnSelectExtendedFeatureItem",
    OnDeselected = "OnDeselectedCanopyTab",
    activePath = "/Game/UMG/Texture_200/Atlas/LobbyVehicle_Atlas/Frames/VehicleTab_Sunroof01_png.VehicleTab_Sunroof01_png",
    inactivePath = "/Game/UMG/Texture_200/Atlas/LobbyVehicle_Atlas/Frames/VehicleTab_Sunroof01_png.VehicleTab_Sunroof01_png"
  },
  {
