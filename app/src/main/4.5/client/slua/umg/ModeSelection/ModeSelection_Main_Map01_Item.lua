...
function ModeSelection_Main_Map01_Item:UpdateTXmissionView()
  ...
  if self.data.id == 20000 or self.data.id == 20010 or self.data.id == 90112 then
    ...
    self:SetTexture(self.UIRoot.Image_Logo, self.data.id == 90112 and "/Game/Mod/Lobby/Base/MatchSelectMap/450/ModeSelection_New/Icon/Lobby_match_lcon04.Lobby_match_lcon04" or "/Game/Mod/Lobby/Split/ModeSelection/NoAtlas/ModeSelection_New/Icon/Lobby_match_lcon03.Lobby_match_lcon03")
  end
end
...
function ModeSelection_Main_Map01_Item:OnButton_ThemeClick()
  ...
  local parent = UIManager.GetUI(UIManager.UI_Config.mode_selection_main)
  if parent and parent.RefreshNarutoBg then
    parent:RefreshNarutoBg()
  end
end
