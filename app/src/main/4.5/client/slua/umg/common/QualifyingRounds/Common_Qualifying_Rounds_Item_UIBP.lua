...
function Common_Qualifying_Rounds_Item_UIBP:RegistEvents()
  ...
  self:AddOnAnimationFinishedEvent("Anim_Refresh_02", self.OnAnimRefreshOver, self, 1)
end
...
function Common_Qualifying_Rounds_Item_UIBP:SetPromotionShow()
  ...
  EventSystem:postEvent(EVENTTYPE_PROMOTION, EVENTID_PROMOTION_SHOW)
end
function Common_Qualifying_Rounds_Item_UIBP:SetPromotionOpen()
  ...
  self.UIRoot.CheckBox_1:SetIsChecked(is_open_promotion or false)
  self.UIRoot.CheckBox_0:SetIsChecked(is_open_promotion or false)
  self:ResetAnimRefresh()
  if is_open_promotion then
    self:PlayUserWidgetAnimation(self.UIRoot.Anim_Refresh_02, 0, 1, 0, 1)
  else
...
function Common_Qualifying_Rounds_Item_UIBP:ResetAnimRefresh()
  ...
  self:StopAnimation("Anim_Refresh_02")
