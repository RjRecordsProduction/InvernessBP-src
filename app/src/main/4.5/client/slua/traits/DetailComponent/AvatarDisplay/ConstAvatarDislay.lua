...
local InitConst = function()
  ConstAvatarDislay.PaddingLeft2D = {
    ...
    [ConstAvatarDislay.ESceneType.XSuitExchange] = 50,
  ...
  ConstAvatarDislay.LevelName = {
    ...
    [ConstAvatarDislay.ESceneType.XSuitBranchSelect] = LobbySceneManager.LEVEL_NAME.XSuitBranchSelect
  }
  ...
  ConstAvatarDislay.CameraID = {
    ...
    [ConstAvatarDislay.ESceneType.XSuitBranchSelect] = Lobby_camera_manager_module.Enum_CameraID.XSuitBranchCamera
  }
