...
style_factory.StylePathMapping = {
  ...
  [3] = "/Game/Mod/Lobby/Base/Wardrobe/Expression_BigItem_UIBP.Expression_BigItem_UIBP",
  [4] = "/Game/Mod/Lobby/Base/Wardrobe/Wardrobe_GunDetailItem_UIBP.Wardrobe_GunDetailItem_UIBP",
