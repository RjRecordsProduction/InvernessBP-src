...
function DeviceOSInfo.getDeviceOSInfo()
  ...
  DeviceOSInfo.InfoList.IDFA = ""
  DeviceOSInfo.InfoList.IDFV = ""
  DeviceOSInfo.InfoList.AdvertisingID = ""
  local PublishRegionMacros = require("client.slua.config.ClientMacros.PublishRegionMacros")
  if PublishRegionMacros.IsVNGVersion() then
    local DevicePlatformNameMacros = require("client.slua.config.ClientMacros.DevicePlatformNameMacros")
    if Client.GetDevicePlatformName() == DevicePlatformNameMacros.Android then
      DeviceOSInfo.InfoList.AdvertisingID = Client.GetPhoneAdvertisingID()
    elseif Client.GetDevicePlatformName() == DevicePlatformNameMacros.IOS then
      DeviceOSInfo.InfoList.IDFA = Client.GetPhoneAdvertisingID()
      DeviceOSInfo.InfoList.IDFV = Client.GetPhoneDeviceID()
    end
  end
  ...
  if IMSDKHelperInstance.GetAdjustID then
    adjustId = IMSDKHelperInstance:GetAdjustID()
  end
  DeviceOSInfo.InfoList.AdjustId = tostring(adjustId)
  if IsWoWEditor then
