...
function logic_lobby_guide_manager:CheckCanGuide_StartGameGuide()
  ...
  if UIManager.IsUIShow(UIManager.UI_Config.Activity_Newbie_Main) then
    log(bWriteLog and "logic_lobby_guide_manager:CheckCanGuide_StartGameGuide Activity_Newbie_Main is show")
    return false
  end
  return true
end
