...
local IsHighLevelAuthorHomePage = function()
  local Logic_UGC_AuthorHome = ModuleManager.GetModule(ModuleManager.LobbyModuleConfig.logic_ugc_authorhome)
  return Logic_UGC_AuthorHome:CheckShowAuthorHomePage(DataMgr.roleData.uid)
end
local UploadUGCPrivacy = function()
  local Privacy = {
    ...
    total_collect_cnt = not LogicSettingBasic.bWoWTotalCollectCnt,
    total_play_cnt = not LogicSettingBasic.bWoWTotalPlayCnt,
    total_follower_cnt = not LogicSettingBasic.bWoWTotalFollowerCnt,
    total_pub_cnt = not LogicSettingBasic.bWoWTotalPubCnt,
    total_play_total_time = not LogicSettingBasic.bWoWTotalPlayTotalTime,
    season_creative_level = not LogicSettingBasic.bWoWSeasonCreativeLevel,
    creator_rank = not LogicSettingBasic.bWoWCreatorRank,
    support_count = not LogicSettingBasic.bWoWSupportCount,
    honors = not LogicSettingBasic.bWoWHonors
  }
...
local Stack_Privacy = {
  ...
  },
  {
    ...
    GetFunc = function()
      ...
      if LobbySystem.CheckOpen(BP_ENUM_ONLY_FRIENFRIEND_PRIVACY) then
        local bShowEvaluation = logic_team_evaluation_view.bShowEvaluation
        if bShowEvaluation == true then
          return 2
        elseif bShowEvaluation == false then
          return 1
        end
        return bShowEvaluation
      end
    end,
    SetFunc = function(_, Value)
      local logic_team_evaluation_view = require("client.slua.logic.team_evaluation.logic_team_evaluation_view")
  ...
  },
  {
    ...
    EventID = EVENTID_UGC_PRIVACY_SETTING_STATUS_NOTIFY,
    GetFunc = function()
      return LogicSettingBasic.bWoWTotalCollectCnt
    end,
    SetFunc = function()
      if not UIUtil.CanClickNow(UIUtil.ClickFrequencyLimit.SettingPrivacySwitchButton) then
        return
      end
      LogicSettingBasic.bWoWTotalCollectCnt = not LogicSettingBasic.bWoWTotalCollectCnt
      UploadUGCPrivacy()
      return true
    end
  },
  {
    ...
    EventID = EVENTID_UGC_PRIVACY_SETTING_STATUS_NOTIFY,
    GetFunc = function()
      return LogicSettingBasic.bWoWTotalPlayCnt
    end,
    SetFunc = function()
      if not UIUtil.CanClickNow(UIUtil.ClickFrequencyLimit.SettingPrivacySwitchButton) then
        return
      end
      LogicSettingBasic.bWoWTotalPlayCnt = not LogicSettingBasic.bWoWTotalPlayCnt
      UploadUGCPrivacy()
    end
  },
  {
    Key = "WoWTotalFollowerCnt",
    UI = AliasMap.Switcher,
    Text = 2026040426,
    ExpandHandle = "WoWShow",
    EventType = EVENTTYPE_UGC,
    EventID = EVENTID_UGC_PRIVACY_SETTING_STATUS_NOTIFY,
    GetFunc = function()
      return LogicSettingBasic.bWoWTotalFollowerCnt
    end,
    SetFunc = function()
      if not UIUtil.CanClickNow(UIUtil.ClickFrequencyLimit.SettingPrivacySwitchButton) then
        return
      end
      LogicSettingBasic.bWoWTotalFollowerCnt = not LogicSettingBasic.bWoWTotalFollowerCnt
      UploadUGCPrivacy()
    end
  },
  {
    ...
    EventID = EVENTID_UGC_PRIVACY_SETTING_STATUS_NOTIFY,
    GetFunc = function()
      return LogicSettingBasic.bWoWTotalPubCnt
    end,
    SetFunc = function()
      if not UIUtil.CanClickNow(UIUtil.ClickFrequencyLimit.SettingPrivacySwitchButton) then
        return
      end
      LogicSettingBasic.bWoWTotalPubCnt = not LogicSettingBasic.bWoWTotalPubCnt
      UploadUGCPrivacy()
    end
  },
  {
    Key = "WoWTotalPlayTotalTime",
    UI = AliasMap.Switcher,
    Text = 2026040428,
    ExpandHandle = "WoWShow",
    EventType = EVENTTYPE_UGC,
    EventID = EVENTID_UGC_PRIVACY_SETTING_STATUS_NOTIFY,
    GetFunc = function()
      return LogicSettingBasic.bWoWTotalPlayTotalTime
    end,
    SetFunc = function()
      if not UIUtil.CanClickNow(UIUtil.ClickFrequencyLimit.SettingPrivacySwitchButton) then
        return
      end
      LogicSettingBasic.bWoWTotalPlayTotalTime = not LogicSettingBasic.bWoWTotalPlayTotalTime
      UploadUGCPrivacy()
    end
  },
  {
    Key = "WoWSeasonCreativeLevel",
    UI = AliasMap.Switcher,
    Text = 2026040429,
    ExpandHandle = "WoWShow",
    EventType = EVENTTYPE_UGC,
    EventID = EVENTID_UGC_PRIVACY_SETTING_STATUS_NOTIFY,
    VisibilityFunc = function()
      return not IsHighLevelAuthorHomePage()
    end,
    GetFunc = function()
      return LogicSettingBasic.bWoWSeasonCreativeLevel
    end,
    SetFunc = function()
      if not UIUtil.CanClickNow(UIUtil.ClickFrequencyLimit.SettingPrivacySwitchButton) then
        return
      end
      LogicSettingBasic.bWoWSeasonCreativeLevel = not LogicSettingBasic.bWoWSeasonCreativeLevel
      UploadUGCPrivacy()
    end
  },
  {
    ...
    EventID = EVENTID_UGC_PRIVACY_SETTING_STATUS_NOTIFY,
    VisibilityFunc = function()
      return IsHighLevelAuthorHomePage()
    end,
    GetFunc = function()
      return LogicSettingBasic.bWoWCreatorRank
    end,
    SetFunc = function()
      if not UIUtil.CanClickNow(UIUtil.ClickFrequencyLimit.SettingPrivacySwitchButton) then
        return
      end
      LogicSettingBasic.bWoWCreatorRank = not LogicSettingBasic.bWoWCreatorRank
      UploadUGCPrivacy()
    end
  },
  {
    ...
    GetFunc = function()
      return LogicSettingBasic.bWoWSupportCount
    end,
    SetFunc = function()
      if not UIUtil.CanClickNow(UIUtil.ClickFrequencyLimit.SettingPrivacySwitchButton) then
        return
      end
      LogicSettingBasic.bWoWSupportCount = not LogicSettingBasic.bWoWSupportCount
      UploadUGCPrivacy()
    end
  },
  {
    ...
    GetFunc = function()
      return LogicSettingBasic.bWoWHonors
    end,
    SetFunc = function()
      if not UIUtil.CanClickNow(UIUtil.ClickFrequencyLimit.SettingPrivacySwitchButton) then
        return
      end
      LogicSettingBasic.bWoWHonors = not LogicSettingBasic.bWoWHonors
      UploadUGCPrivacy()
    end
  },
  {
  ...
  },
  {
    ...
    Text = 86035,
    Help = function()
      UIManager.ShowUI(UIManager.UI_Config.common_protocol_msg, 0, LocUtil.GetLocalizeResStr(86035), LocUtil.GetLocalizeResStr(86036))
    end,
    VisibilityFunc = function()
      if IsWoWEditor then
        return false
  ...
  {
    Key = "PCDefaultInvisible",
    UI = AliasMap.Switcher,
    Text = 18710244,
    GetFunc = function()
      local SettingSystem = require("client.logic.setting.logic_setting")
      return SettingSystem.GetPCDefaultInvisible()
    end,
    SetFunc = function(_, value)
      if not UIUtil.CanClickNow(UIUtil.ClickFrequencyLimit.SpaceSecrecySetting) then
        return
      ...
      local SettingSystem = require("client.logic.setting.logic_setting")
      local bOldValue = SettingSystem.GetPCDefaultInvisible()
      if value == bOldValue then
        return true
      end
      SettingSystem.SavePCDefaultInvisible(value)
      if value then
        SettingSystem.ApplyStealthIfNeeded()
      end
      return true
    end,
    VisibilityFunc = function()
      ...
      return DevicePlatformNameMacros.IsPC()
    end
  },
  {
    Key = "Guardian",
