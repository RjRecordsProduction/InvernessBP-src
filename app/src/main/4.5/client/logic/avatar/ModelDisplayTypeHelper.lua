...
function ModelDisplayTypeHelper.IsLegendEuqip(ItemID)
  local logic_legend_weapon = ModuleManager.GetModule(ModuleManager.LobbyModuleConfig.logic_legend_weapon)
  return logic_legend_weapon:IsLegendWeaponItem(ItemID)
end
...
function ModelDisplayTypeHelper._IsChatRoomBackground(itemType)
  return itemType == ENUM_ITEM_TYPE.ChatBG
end
...
function ModelDisplayTypeHelper.IsVehicleWheelHub(type, subType)
  return type == ENUM_ITEM_TYPE.VehicleDecoration and subType == ENUM_ITEM_SUBTYPE.VehicleWheelHub
end
function ModelDisplayTypeHelper.IsVehicleBrakeCaliper(type, subType)
  return type == ENUM_ITEM_TYPE.VehicleDecoration and subType == ENUM_ITEM_SUBTYPE.VehicleBrakeCaliper
end
function ModelDisplayTypeHelper.IsVehicleCanopy(type, subType)
  return type == ENUM_ITEM_TYPE.VehicleDecoration and subType == ENUM_ITEM_SUBTYPE.VehicleCanopy
end
function ModelDisplayTypeHelper.IsVehiclePartDisplay(type, subType)
  if type ~= ENUM_ITEM_TYPE.VehicleDecoration then
    return false
  end
  return subType == ENUM_ITEM_SUBTYPE.VehicleWheelHub or subType == ENUM_ITEM_SUBTYPE.VehicleBrakeCaliper or subType == ENUM_ITEM_SUBTYPE.VehicleCanopy
end
function ModelDisplayTypeHelper.IsCabrioletCar(subType)
  return subType == ENUM_ITEM_SUBTYPE.Mirado or subType == ENUM_ITEM_SUBTYPE.Roadster
end
