...
local spData = super_data.CreateSuperData({
  ...
  backgroundRed = false,
  openingRed = false,
  ProfileFrameRed = false,
  SocialCardFrame = false,
...
function roleinfo_red_data.RegistRedEvent()
  ...
  EventSystem:registEvent(EVENTTYPE_ROLEINFO, EVENTID_ROLEINFO_UPDATE_PROFILE_FRAME_REDDOT, roleinfo_red_data.RefreshProfileFrameRed)
  EventSystem:registEvent(EVENTTYPE_ROLEINFO, EVENTID_ROLEINFO_UPDATE_SOCIALCARD_FRAME_REDDOT, roleinfo_red_data.RefreshSocialCardFrame)
...
function roleinfo_red_data.CheckSettingRed()
  return spData.avatarRed or spData.avatarFrameRed or spData.aliasRed or spData.nameFrameRed or spData.teamupFrameRed or spData.carteFrameRed or spData.soicalcardRed or spData.nicknameFrameRed or spData.chatFrameRed or spData.lightBoardRed or spData.backgroundRed or spData.openingRed or spData.homeDoorPlateRed or spData.nicknameColorRed or spData.chatRoomBGRed or spData.ProfileFrameRed or spData.SocialCardFrame
end
...
function roleinfo_red_data.RefreshAll()
  ...
  roleinfo_red_data.RefreshProfileFrameRed()
  roleinfo_red_data.RefreshSocialCardFrame()
end
...
function roleinfo_red_data.RefreshProfileFrameRed()
  local logic_roleInfo_profileframe = ModuleManager.GetModule(ModuleManager.LobbyModuleConfig.logic_roleInfo_profileframe)
  spData.ProfileFrameRed = logic_roleInfo_profileframe:HaveRed()
  spData.settingRed = roleinfo_red_data.CheckSettingRed()
  spData.baseInfoRed = spData.settingRed or spData.levelTaskRed
end
function roleinfo_red_data.RefreshSocialCardFrame()
  ...
  spData.SocialCardFrame = logic_roleInfo_socialcardframe:HaveRed()
  spData.settingRed = roleinfo_red_data.CheckSettingRed()
  spData.baseInfoRed = spData.settingRed or spData.levelTaskRed
end
