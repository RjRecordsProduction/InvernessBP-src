...
function AceImprintLogic.SetAceImprintItem(AceImprintItem, ace_imprint_show_id, ace_imprint_base_id, AceImprintStyle, ace_imprint_show_cnt)
  ...
  local ace_base_id, ace_num = AceImprintLogic.GetAceImprintBaseId(ace_imprint_show_id, ace_imprint_base_id, ace_imprint_show_cnt)
...
function AceImprintLogic.SetAceImprintImage(Common_KingMark_UIBP, ace_imprint_show_id, ace_imprint_base_id, ace_imprint_show_cnt)
...
function AceImprintLogic.SetAceImprintImageWithGrey(Common_KingMark_UIBP, ace_imprint_show_id, ace_imprint_base_id, isGrey, ace_imprint_show_cnt)
  if Common_KingMark_UIBP == nil then
    return
  end
  if not slua.isValid(Common_KingMark_UIBP) then
...
function AceImprintLogic.SetSelfAceImprintItem(AceImprintItem, AceImprintStyle)
  ...
  AceImprintLogic.SetAceImprintItem(AceImprintItem, DataMgr.ace_imprint_show_id, DataMgr.ace_imprint_base_id, AceImprintStyle, DataMgr.ace_imprint_show_cnt)
end
function AceImprintLogic.SetSelfAceImprintImage(Common_KingMark_UIBP)
  AceImprintLogic.SetAceImprintImage(Common_KingMark_UIBP, DataMgr.ace_imprint_show_id, DataMgr.ace_imprint_base_id, DataMgr.ace_imprint_show_cnt)
end
function AceImprintLogic.GetAceImprintBaseId(ace_imprint_show_id, ace_imprint_base_id, ace_imprint_show_cnt)
  if ace_imprint_base_id and 0 < ace_imprint_base_id then
    local ace_num = ace_imprint_show_id - ace_imprint_base_id
    if ace_num <= 0 and ace_imprint_show_cnt and 0 < ace_imprint_show_cnt then
      ace_num = ace_imprint_show_cnt
    end
    return ace_imprint_base_id, ace_num
  end
