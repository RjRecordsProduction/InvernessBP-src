...
function logic_recharge_jk.GetRechargeData()
  logic_recharge_jk.InitializeTableData()
  return logic_recharge_jk.tDataList
end
...
function logic_recharge_jk.CentauriMPEventHandler(_, _, CentauriRechargeCode)
  ...
  if mpCache.resultCode == "0" or mpCache.resultCode == 0 then
    ...
    log(bWriteLog and mpCache.presentLevel .. "  self cast mpCache.presentLevel to  :  " .. tempStr)
