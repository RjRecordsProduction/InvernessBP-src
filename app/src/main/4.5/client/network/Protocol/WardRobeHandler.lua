...
function WardRobeHandler.send_get_motion_plating_wheel_req()
  log(bWriteLog and "WardRobeHandler.send_get_motion_plating_wheel_req")
  NetManager.SendPkg(1591064871)
end
function WardRobeHandler.on_get_motion_plating_wheel_rsp(err_code, wheel_list, max_slot)
  log(bWriteLog and string.format("WardRobeHandler.on_get_motion_plating_wheel_rsp err_code:%s max_slot:%s", tostring(err_code), tostring(max_slot)))
  log_tree("on_get_motion_plating_wheel_rsp wheel_list:", wheel_list)
  local logic_wardrobe_wheel = ModuleManager.GetModule(ModuleManager.LobbyModuleConfig.logic_wardrobe_wheel)
  logic_wardrobe_wheel:on_get_wheel_rsp(err_code, wheel_list)
end
function WardRobeHandler.send_set_motion_plating_wheel_req(wheel_list)
  log_tree("WardRobeHandler.send_set_motion_plating_wheel_req wheel_list:", wheel_list)
  NetManager.SendPkg(1964452135, wheel_list)
end
function WardRobeHandler.on_set_motion_plating_wheel_rsp(err_code, wheel_list)
  log(bWriteLog and "WardRobeHandler.on_set_motion_plating_wheel_rsp err_code:" .. tostring(err_code))
  log_tree("on_set_motion_plating_wheel_rsp wheel_list:", wheel_list)
  local logic_wardrobe_wheel = ModuleManager.GetModule(ModuleManager.LobbyModuleConfig.logic_wardrobe_wheel)
  logic_wardrobe_wheel:on_set_wheel_rsp(err_code, wheel_list)
end
local reqRsp = {
