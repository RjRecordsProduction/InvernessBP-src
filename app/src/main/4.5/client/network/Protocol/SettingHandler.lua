...
function SettingHandler.on_save_custom_setting_rsp(result, operType, slotType)
  print("SettingHandler.on_save_custom_setting_rsp", result, slotType)
end
...
function SettingHandler.send_gen_csetting_share_code_req(slotType)
  log(bWriteLog and "SettingHandler.send_gen_csetting_share_code_req", slotType)
  NetManager.SendPkg(2059037299, slotType)
end
function SettingHandler.on_gen_csetting_share_code_rsp(err_code, share_code)
  log(bWriteLog and "SettingHandler.on_gen_csetting_share_code_rsp", err_code, share_code)
  if err_code == 0 then
    EventSystem:postEvent(EVENTTYPE_SETTING, EVENTID_SETTING_REFRESH_SHARECODE, share_code)
  elseif err_code == 504006 or err_code == 504002 then
    ShowNotice(11454)
    EventSystem:postEvent(EVENTTYPE_SETTING, EVENTID_SETTING_REFRESH_SHARECODE)
  else
    ShowNotice(11457)
    EventSystem:postEvent(EVENTTYPE_SETTING, EVENTID_SETTING_REFRESH_SHARECODE)
  end
end
function SettingHandler.send_query_csetting_share_code_req(slotType)
  log(bWriteLog and "SettingHandler.send_query_csetting_share_code_req", slotType)
  NetManager.SendPkg(1191209883, slotType)
end
function SettingHandler.on_query_csetting_share_code_rsp(err_code, share_code)
  log(bWriteLog and "SettingHandler.on_query_csetting_share_code_rsp", err_code, share_code)
  EventSystem:postEvent(EVENTTYPE_SETTING, EVENTID_SETTING_REFRESH_SHARECODE, share_code)
end
function SettingHandler.send_query_csetting_shared_data_req(share_code)
  log(bWriteLog and "SettingHandler.send_query_csetting_shared_data_req", share_code)
  NetManager.SendPkg(395068967, share_code)
end
function SettingHandler.on_query_csetting_shared_data_rsp(err_code, data)
  local logic_setting_layout_share = require("client.slua.logic.setting.logic_setting_layout_share")
  logic_setting_layout_share.OnQuerySharedDataRsp(data)
end
