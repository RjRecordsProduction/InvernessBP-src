...
function ProfileHander.send_batch_get_bin_profile_req(sendSeq, binListUid, rankDataFlag, count, module_id, incl_flag)
  log(bWriteLog and string.format("ProfileHander.send_batch_get_bin_profile_req sendseq = %d, rankDataFlag = %d, count = %d, module_id = %d, incl_flag = %d", sendSeq, rankDataFlag, count, module_id, incl_flag))
