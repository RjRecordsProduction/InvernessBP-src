...
GameComponentData.SwimComponent = "BP_SwimController"
...
function GameComponentData.AddSelfSwimComponentEvent(DelegateContainer, EventName, HandleFunc, ...)
  GameComponentData._AddPlayerCharacterComponentEvent(GameComponentData.SwimComponent, DelegateContainer, EventName, HandleFunc, ...)
end
