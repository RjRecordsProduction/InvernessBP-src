...
function GameplayData.GetLocalCharacter()
  ...
  if slua.isValid(PC) then
    Pawn = PC:GetCurPlayerCharacter()
  end
  if not slua.isValid(Pawn) then
    Pawn = GameplayData.GetPlayerCharacter()
  end
  return Pawn
end
function GameplayData.IsLocalCharacter(uCharacter)
  return uCharacter == GameplayData.GetLocalCharacter()
end
