...
function VoiceRecommendationSubsystem:OnRelease()
  ...
  for _, ConditionEntry in ipairs(self.ConditionTable) do
    if ConditionEntry.Condition and ConditionEntry.Condition.Clear then
      ConditionEntry.Condition:Clear()
    end
  end
  self.ConditionTable = {}
