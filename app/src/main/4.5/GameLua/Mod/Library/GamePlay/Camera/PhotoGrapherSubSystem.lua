...
function PhotoGrapherSubSystem:EnterNoUIMode()
  ...
  self.CahceJoyStickopacity = PlayerController:GetJoyStickOpacity()
  ...
  self:AddControlEvent(PlayerController, "OnPostTakeDamageDelegate", self.OnSmartCameraDamageInterrupt, self)
...
function PhotoGrapherSubSystem:RemoveEvent()
  ...
  self:RemoveControlEvent(PlayerController, "OnPostTakeDamageDelegate")
...
function PhotoGrapherSubSystem:OnSmartCameraDamageInterrupt(Damage, DamageEvent, EventInstigator, DamageCauser, DamageType)
  print(bWriteLog and "PhotoGrapherSubSystem:OnSmartCameraDamageInterrupt")
  if 0 < Damage then
    local IngameSelfieSubsystem = SubsystemMgr:Get("IngameSelfieSubsystem")
    if IngameSelfieSubsystem and IngameSelfieSubsystem:CheckIgnoreDamageTypes(DamageType) then
      print(bWriteLog and "PhotoGrapherSubSystem:OnSmartCameraDamageInterrupt IgnoreDamageType: " .. tostring(DamageType))
      return
    end
    self:LeaveNoUIMode()
  end
...
function PhotoGrapherSubSystem:ModifyPetOpen(bPetOpen)
  ...
  SettingModule:SetOptionValue("OpenMyPet", bPetOpen)
end
function PhotoGrapherSubSystem:GetPetOpen()
  ...
  local SettingModule = ModuleManager.GetModule(ModuleManager.CommonModuleConfig.SettingModule)
  return SettingModule:GetOptionValue("OpenMyPet")
end
