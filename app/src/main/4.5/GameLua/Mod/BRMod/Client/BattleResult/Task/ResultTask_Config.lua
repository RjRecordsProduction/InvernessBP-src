...
local ResultTask_Config = {
  Configs = {
    [ResultTask_Macro.ENUM_TaskType.RP] = {
      Logic = "GameLua.Mod.BRMod.Client.BattleResult.Task.RP.ResultTask_RP_Logic",
      UIUtil = "GameLua.Mod.BRMod.Client.BattleResult.Task.RP.ResultTask_RP_UI_Util",
    ...
    [ResultTask_Macro.ENUM_TaskType.RankAward] = {
      Logic = "GameLua.Mod.BRMod.Client.BattleResult.Task.RankAward.ResultTask_RankAward_Logic",
      UIUtil = "GameLua.Mod.BRMod.Client.BattleResult.Task.RankAward.ResultTask_RankAward_UI_Util",
    ...
    [ResultTask_Macro.ENUM_TaskType.ManorDrawReward] = {
      Logic = "GameLua.Mod.BRMod.Client.BattleResult.Task.ManorDrawReward.ResultTask_ManorDrawReward_Logic",
      UIUtil = "GameLua.Mod.BRMod.Client.BattleResult.Task.ManorDrawReward.ResultTask_ManorDrawReward_UI_Util",
      TaskType_ImagePath = nil,
      TaskType_TextID = 62401,
      nShowSort = 25
    },
    [ResultTask_Macro.ENUM_TaskType.SmallRP] = {
      Logic = "GameLua.Mod.BRMod.Client.BattleResult.Task.SmallRP.ResultTask_SmallRP_Logic",
      UIUtil = "GameLua.Mod.BRMod.Client.BattleResult.Task.SmallRP.ResultTask_SmallRP_UIUtil",
    ...
    [ResultTask_Macro.ENUM_TaskType.DailyTask] = {
      Logic = "GameLua.Mod.BRMod.Client.BattleResult.Task.DailyTask.ResultTask_DailyTask_Logic",
      UIUtil = "GameLua.Mod.BRMod.Client.BattleResult.Task.DailyTask.ResultTask_DailyTask_UI_Util",
    ...
    [ResultTask_Macro.ENUM_TaskType.LevelTask] = {
      Logic = "GameLua.Mod.BRMod.Client.BattleResult.Task.LevelTask.ResultTask_LevelTask_Logic",
      UIUtil = "GameLua.Mod.BRMod.Client.BattleResult.Task.LevelTask.ResultTask_LevelTask_UI_Util",
    ...
    [ResultTask_Macro.ENUM_TaskType.BP] = {
      Logic = "GameLua.Mod.BRMod.Client.BattleResult.Task.BP.ResultTask_BP_Logic",
      UIUtil = "GameLua.Mod.BRMod.Client.BattleResult.Task.BP.ResultTask_BP_UI_Util",
