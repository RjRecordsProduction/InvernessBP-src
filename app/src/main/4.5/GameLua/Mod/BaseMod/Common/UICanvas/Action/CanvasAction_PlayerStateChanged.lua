...
function CanvasAction_PlayerStateChanged:BindEvent()
  ...
  self.DelegateContainer:AddDataListener(GameplayData.GetSuperData(), "PlayerController", self.OnPlayerControllerChange, self)
  self.DelegateContainer:AddDataListener(GameplayData.GetSuperData(), "PlayerCharacter", self.OnPlayerControllerChange, self)
end
function CanvasAction_PlayerStateChanged:OnPlayerControllerChange()
