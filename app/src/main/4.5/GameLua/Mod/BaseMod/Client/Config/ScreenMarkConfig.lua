...
local ScreenMarkUIGroupConfig = {
  ...
  [1100] = {
    UIPathName = "/Game/Library/Res/Items/SPSuit/Arts/UI/Atlas/Frames/SPSuit_ICON_Footprint_png.SPSuit_ICON_Footprint_png",
    MaxWidgetNum = 16,
    MaxShowDistance = 6000,
    MinShowDistance = 0,
    IconSize = FVector2D(40, 40),
    UIOffset = FVector2D(0, 0),
    bBindOutScreen = false,
    bBindBlocked = true,
    bIsBindingActor = false,
    bIsUpdatedByPanel = true,
    bNeedPreLoad = true,
    bNeedUpdateState = false,
    WorldPositionOffset = FVector(0, 0, 30)
  },
  [450999] = {
    UIPathName = "/Game/Mod/EvoBase/BluePrints/UI/ScreenMark/Item/CommonActorScreenMark_UIBP.CommonActorScreenMark_UIBP_C",
    ...
    bNeedUpdateState = true,
    CommonMarkConfig = {
      Icon = "/Game/Mod/VersionRes/450/Arts/UI/Atlas/Frames/ZD_Icon_Map_Ferrari_png.ZD_Icon_Map_Ferrari_png",
      bCountDownTime = false,
      bDistance = true
    }
  }
