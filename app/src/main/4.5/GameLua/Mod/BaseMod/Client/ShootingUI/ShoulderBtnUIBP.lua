...
function ShoulderBtnPanel:Initialize()
  ...
  self:AddSettingOptionEvent("RotateViewWithShoulderSwitch", function(bRotateViewWithShoulderSwitch)
  ...
  self:AddSettingOptionEvent("ShoulderEnable", function(bShoulderEnable)
...
function ShoulderBtnPanel:HandleCharacterCommonEventDelegate(sEventMsg)
  ...
  if sEventMsg == "ShoulderState" then
    ...
    if slua.isValid(uController) and uController.GetPlayerCharacterSafety then
