...
function CircleChooseUtil.GetAvatarPath(ItemID, bMed, bWithSkin)
  ...
  if bMed then
    ...
    if AvatarItemIconPath and AvatarItemIconPath ~= "" then
    ...
    elseif Client.IsDevelopment() then
      ShowNotice(string.format("###[\229\134\133\231\189\145Dev\230\143\144\231\164\186]: \231\137\169\229\147\129\232\161\168.xls-\231\137\169\229\147\129\229\176\143\229\155\190\230\160\135\232\183\175\229\190\132 \231\173\150\229\136\146\230\156\170\233\133\141\231\189\174 AvatarID:%s", AvatarID))
    end
  end
