...
local UIConfig_UI = {
  ...
  SpiderShackleUI = {
    moduleName = "GameLua.Mod.Library.Client.UI.SpiderSilkHand.SpiderShackleUI",
    path = "/Game/Library/Res/Weapons/SPSilkHand/Blueprints/UI/SpiderShackle2_UI.SpiderShackle2_UI",
    containerName = UIContainers.Default,
    isSingleton = true,
    asy = true,
    isMainUI = false,
  ...
  SpiderSilkGloveLeftUI = {
    moduleName = "GameLua.Mod.Library.Client.UI.SpiderSilkHand.SpiderSilkGloveLeftUI",
    path = "/Game/Library/Res/Weapons/SPSilkHand/BluePrints/UI/SpiderSkill_ControlUI.SpiderSkill_ControlUI",
    isMainUI = false,
    isSingleton = true,
    zOrder = 0,
    asy = true,
  ...
  SpiderSilkGloveRightUI = {
    moduleName = "GameLua.Mod.Library.Client.UI.SpiderSilkHand.SpiderSilkGloveRightUI",
    path = "/Game/Library/Res/Weapons/SPSilkHand/BluePrints/UI/SpiderSkill_ControlUI.SpiderSkill_ControlUI",
    isMainUI = false,
    isSingleton = true,
    zOrder = 0,
  ...
  SPSuit_TraceGuidance_UIBP = {
    moduleName = "GameLua.Mod.Library.Client.UI.SPSuit.SPSuit_TraceGuidance_UIBP",
    path = "/Game/Library/Res/Items/SPSuit/BluePrints/UI/SPSuit_TraceGuidance_UIBP.SPSuit_TraceGuidance_UIBP",
    isMainUI = false,
    isSingleton = true,
    zOrder = 0,
    asy = true,
    closeOnHide = false,
    uiStat = {
      name = "SPSuit_TraceGuidance_UIBP"
    }
  },
  QuickTweakPanel_CustomLayout = {
    moduleName = "GameLua.Mod.BaseMod.Client.Setting.QuickTweakPanel_CustomLayout",
    path = "/Game/UMG/UI_BP/Setting/UILayout/WBP_QuickTweak_CustomLayout.WBP_QuickTweak_CustomLayout",
    uiStat = {
      name = "QuickTweakPanel_CustomLayout"
    },
    asy = true,
    loadFromPool = EUIConfigPoolType.None
  },
  QuickTweakPanel_Blur = {
    moduleName = "GameLua.Mod.BaseMod.Client.Setting.QuickTweakPanel_Blur",
    path = "/Game/UMG/UI_BP/Setting/UILayout/WBP_QuickTweak_Backgroud.WBP_QuickTweak_Backgroud",
    containerName = UIContainers.Bottom,
    asy = true,
    zOrder = 0,
    loadFromPool = EUIConfigPoolType.None
  },
  IngameCarryMinatiBossHP = {
    moduleName = "GameLua.Mod.Library.GamePlay.AI.CarryMinatiBoss.UI.IngameCarryMinatiBossHP",
    path = "/Game/Library/Res/AI/CarryMinatiBoss/BluePrints/UI/IngameCarryMinatiBossHP_UIBP.IngameCarryMinatiBossHP_UIBP",
    containerName = UIContainers.Bottom,
    uiStat = {
      name = "IngameCarryMinatiBossHP"
    },
    isMainUI = false
  }
}
