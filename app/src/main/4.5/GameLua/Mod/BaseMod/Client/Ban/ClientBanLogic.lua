...
function ClientBanLogic.IsBanned()
  local TimeUtil = require("client.common.time_util")
  local UTCTime = TimeUtil.GetServerTimeInSec()
  return UTCTime < ClientBanLogic.VoiceBanEndTime
end
function ClientBanLogic.PostBannedNotif()
  local TimeUtil = require("client.common.time_util")
  if ClientBanLogic.IsTranslated and ClientBanLogic.Reason ~= "" then
...
function ClientBanLogic.TryOpenVoice()
  print(bWriteLog and "debug Ban: TryOpenVoice")
  if ClientBanLogic.IsBanned() then
