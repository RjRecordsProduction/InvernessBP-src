...
local UIConfig_KillInfo = {
  ...
  KingEliminationItemTipsForXSuit = {
    moduleName = "GameLua.Mod.BaseMod.Client.KillInfoTips.KingEliminationItemTipsForXSuit",
    path = "/Game/BluePrints/ControlInput/IngameUI/TipsItem/KillEffect_Elimination_King_Tips_450.KillEffect_Elimination_King_Tips_450",
    isSingleton = true,
    uiStat = {
      name = "KingEliminationItemTips"
    },
