...
function PickUpListPanel_BP:OnClicked_Button_PickupTombBox()
  ...
  if PlayerCharacter:AllowState(EPawnState.CarryBox, true) then
    ...
    if slua.isValid(self.CarryPlayerTombBox) and PlayerCharacter.ServerRPC_CarryDeadBox then
...
function PickUpListPanel_BP:RegistSettings()
  ...
  self:AddSettingOptionEvent("AutoPickupSwitcher", function(bAutoPickupSwitch)
  ...
  self:AddSettingOptionEvent("DisableAutoPickupSwitcher", function(bDisableAutoPickupSwitcher)
  ...
  self:AddSettingOptionEvent("PickUpListMode", function(nPickUpListMode)
  ...
  self:AddSettingOptionEvent("AutoPickMeleeType", function(AutoPickMeleeType)
...
function PickUpListPanel_BP:ChangeLayoutOnBackpackShow(bShow, bBRTDMStore)
  if bShow then
    ...
    self.UIRoot.Canvas_PickBox:UpdateCustomLayout()
    self.UIRoot.CustomizePickUpPanel_BP.Canvas_PickUp:UpdateCustomLayout()
...
function PickUpListPanel_BP:SetAutoPickMeleeType(AutoPickMeleeType)
  ...
  local SettingModule = ModuleManager.GetModule(ModuleManager.CommonModuleConfig.SettingModule)
  local AutoPickMeleeType = SettingModule:GetOptionValue("AutoPickMeleeType")
