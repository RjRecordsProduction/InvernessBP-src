...
local UIConfig_Vehicle = {
  ...
  PanoramicSunroofUI = {
    moduleName = "GameLua.Mod.Library.Client.UI.VehicleControl.VehicleItem.PanoramicSunroofUI",
    path = "/Game/BluePrints/ControlInput/PanoramicSunroof_UIBP.PanoramicSunroof_UIBP",
    isSingleton = true,
    isMainUI = false,
    asy = true,
    uiStat = {
      name = "PanoramicSunroofUI"
    }
  },
  VehicleHybridUI = {
    moduleName = "GameLua.Mod.Library.Client.UI.VehicleControl.VehicleItem.VehicleHybridUI",
    path = "/Game/BluePrints/ControlInput/IngameUI/Vehicle/Ferrari_VehicleButton_Item.Ferrari_VehicleButton_Item",
    isSingleton = true,
    isMainUI = false,
    asy = true,
    uiStat = {
      name = "VehicleHybridUI"
    }
  }
}
