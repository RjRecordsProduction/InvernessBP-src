...
function CircleChooseMedicineNew:OnInitialize()
  ...
  self:SetCustomLayout(CustomType._3_FirstAid)
...
function CircleChooseMedicineNew:UpdateCenterSlot()
  if not self.MySubsystem then
    print(bWriteLog and "CircleChooseMedicineNew:UpdateCenterSlot self.MySubsystem is nil")
    return
  end
