local BasicSkillsMenuBP_Config = {
  ...
  InteractTypes = {
    ...
    Type_MVPStatueCelerbrate = {
      IconPath = "/Game/Arts/UI/TableIcons/Emote/Icon_Emote_VictoryDance166_128.Icon_Emote_VictoryDance166_128",
      TextID = 48896,
    ...
    Type_Execute = {
      IconPath = "/Game/UMG/Texture_200/Atlas/Detail/Frames/Common_Details_ExecutionSystem02_png.Common_Details_ExecutionSystem02_png",
      TextID = 23140041,
      ActionOnClick = "Action_Execute"
    }
  }
}
