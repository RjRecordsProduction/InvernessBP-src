...
function PistolSlotModeBase:UpdatePistol()
  ...
  local bCanRecordHitDetailFromEntity = false
  if CurrWeapon.GetCanRecordHitDetailFromEntity then
    bCanRecordHitDetailFromEntity = CurrWeapon:GetCanRecordHitDetailFromEntity()
  end
...
function PistolSlotModeBase:OnSafeZoneAppear()
  local PlayerController = GameplayData.GetPlayerController()
  if not slua.isValid(PlayerController) then
    return
  end
  self:UpdateAirDropType(PlayerController.bIsPlayerInWhiteCircle)
end
