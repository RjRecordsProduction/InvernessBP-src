...
function BasicSkillsMenuBP:RegistEvents()
  ...
  self:AddControlEventByControl(self.UIRoot.Button_PutDown, "OnPressed", self.OnPressedCarryBackBtn, self)
  self:AddControlEventByControl(self.UIRoot.Button_PutDown, "OnReleased", self.OnReleasedCarryBackBtn, self)
  ...
  self:AddControlEventByControl(self.UIRoot.BtnRescue, "OnPressed", self.OnPressedBtnRescue, self)
  self:AddControlEventByControl(self.UIRoot.BtnRescue, "OnReleased", self.OnReleasedBtnRescue, self)
  ...
  if slua.isValid(CGameState) then
    ...
    self:AddControlEventByControl(DelegateMgrInstance, "OnCanExecuteOtherChange", self.OnCanExecuteOtherEvent, self)
...
function BasicSkillsMenuBP:OnPressedCarryBackBtn()
  print(bWriteLog and "[Resuce]BasicSkillsMenuBP:OnPressedCarryBackBtn")
  EventSystem:postEvent(EVENTTYPE_INGAME_CREATIVE_MODE, EVENTID_UGC_NATIVE_BUTTON_PRESSED, "Carry")
end
function BasicSkillsMenuBP:OnReleasedCarryBackBtn()
  print(bWriteLog and "[Resuce]BasicSkillsMenuBP:OnReleasedCarryBackBtn")
  EventSystem:postEvent(EVENTTYPE_INGAME_CREATIVE_MODE, EVENTID_UGC_NATIVE_BUTTON_RELEASED, "Carry")
end
function BasicSkillsMenuBP:OnPressedBtnRescue()
  print(bWriteLog and "[Resuce]BasicSkillsMenuBP:OnPressedBtnRescue")
  EventSystem:postEvent(EVENTTYPE_INGAME_CREATIVE_MODE, EVENTID_UGC_NATIVE_BUTTON_PRESSED, "Rescue")
end
function BasicSkillsMenuBP:OnReleasedBtnRescue()
  print(bWriteLog and "[Resuce]BasicSkillsMenuBP:OnReleasedBtnRescue")
  EventSystem:postEvent(EVENTTYPE_INGAME_CREATIVE_MODE, EVENTID_UGC_NATIVE_BUTTON_RELEASED, "Rescue")
end
...
function BasicSkillsMenuBP:OnCanExecuteOtherEvent(ExecuteWho, Owner, IsTurnInto)
  self:NewOnCanExecuteOtherEvent(ExecuteWho, Owner, IsTurnInto)
end
