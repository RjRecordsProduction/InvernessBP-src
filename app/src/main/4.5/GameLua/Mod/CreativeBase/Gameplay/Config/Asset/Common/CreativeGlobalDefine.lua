...
CreativeGlobalDefine.E_AssetType = {
  ...
  Task = 19,
  Store = 20,
  HomeLandRes_Struct = 21,
  HomeLandRes_Decor = 22,
  GraphData = 23
}
...
CreativeGlobalDefine.DefaultStaticMeshGameObjectPath = "/Game/Mod/CreativeCore/BluePrints/Object/GameObjects/BP_CreativeMode_StaticMeshObject.BP_CreativeMode_StaticMeshObject_C"
CreativeGlobalDefine.BaseEditorObjectPath = "/Game/Mod/CreativeEdit/BluePrints/Object/BP_CreativeMode_EditorObject.BP_CreativeMode_EditorObject_C"
...
CreativeGlobalDefine.ActorBuildBaseEditorObjectPath = "/Game/Mod/CreativeEdit/BluePrints/Object/EditorObjects/BP_CreativeEditorObject_ActorBuild.BP_CreativeEditorObject_ActorBuild_C"
...
CreativeGlobalDefine.DebugObjectPath = "/Game/Mod/CreativeEdit/Arts_PlayerBluePrints/DebugObject/BP_CreativeModeEditorActor_DebugObject.BP_CreativeModeEditorActor_DebugObject_C"
...
CreativeGlobalDefine.ActorAttributePriority = {
  ...
  InitPlayer = CreativeGlobalDefine.OverridePriority.MEDIUM_LOW,
  UserRuntimeCode = CreativeGlobalDefine.OverridePriority.MEDIUM
}
...
CreativeGlobalDefine.Enum_DeviceParamErrorType = {
  None = 0,
  Success = 1,
  Unreadable = 2,
  KeyError = 3,
...
CreativeGlobalDefine.MonsterOffcialCodePlanList = {
  {
    ...
    Desc = 18710001,
    CanSelect = true,
    Image = "/Game/Mod/CreativeEdit/Arts/NoAtlas/BlockyluaTexture/TemplateGraph/LevelTemplate/TemplateGraph_Image_MonsterLevelTemplate.TemplateGraph_Image_MonsterLevelTemplate"
  },
  {
    CodePlanID = 1,
    ShowName = 17005112,
    Desc = 18710002,
    CanSelect = false,
    Image = "/Game/Mod/CreativeEdit/Arts/NoAtlas/BlockyluaTexture/TemplateGraph/LevelTemplate/TemplateGraph_Image_MonsterBlankTemplate.TemplateGraph_Image_MonsterBlankTemplate"
  }
}
CreativeGlobalDefine.ArmedAIOffcialCodePlanList = {
  {
    ...
    Desc = 18710003,
    CanSelect = true,
    Image = "/Game/Mod/CreativeEdit/Arts/NoAtlas/BlockyluaTexture/TemplateGraph/LevelTemplate/TemplateGraph_Image_ArmedAILevelTemplate.TemplateGraph_Image_ArmedAILevelTemplate"
  },
  {
    CodePlanID = 1,
    ShowName = 17005112,
    Desc = 18710004,
    CanSelect = false,
    Image = "/Game/Mod/CreativeEdit/Arts/NoAtlas/BlockyluaTexture/TemplateGraph/LevelTemplate/TemplateGraph_Image_ArmedAIBlankTemplate.TemplateGraph_Image_ArmedAIBlankTemplate"
  }
}
