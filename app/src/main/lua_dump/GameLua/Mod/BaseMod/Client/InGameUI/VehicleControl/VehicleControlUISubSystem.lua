...
function VehicleControlUISubSystem:_PostConstruct()
end
function VehicleControlUISubSystem:OnInit()
  print(bWriteLog and "VehicleControlUISubSystem:OnInit")
...
function VehicleControlUISubSystem:OnExitVehicle()
  ...
  if slua.isValid(PlayerController) then
    if self._VehicleModeInUsing == 1 or self._VehicleModeInUsing == 3 or self._VehicleModeInUsing == 4 then
