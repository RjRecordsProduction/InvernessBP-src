...
function MultiLayerPModePanel:HandleSwitchPModeVisibility()
  ...
  SettingSubsystem:RegisterUserSettingsDelegate_Bool("FpViewSwitch", function(bFpp)
    print(bWriteLog and "MultiLayerPModePanel:RegisterUserSettingsDelegate_Bool", bFpp)
    self:RefreshSwitchPMode(bFpp)
  end)
  self:RefreshSwitchPMode(SettingSubsystem:GetUserSettings_Bool("FpViewSwitch"))
end
