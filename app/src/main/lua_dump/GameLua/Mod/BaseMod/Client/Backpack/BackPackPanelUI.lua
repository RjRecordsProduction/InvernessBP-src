...
function BackPackPanelUI:CreateExItems()
  ...
  self:AttachChildWindow("GridPanel_1", self.PickUpItemTips)
  ...
  ItemSlot:SetPadding(FMargin(0, 0, 230, 0))
  self.UIRoot.GridPanel_1:ReSortSlot()
...
function BackPackPanelUI:CheckIsShowMeleeGuide(DefineID, OperationType, Reason)
  ...
  if not SettingSubsystem or SettingSubsystem:GetUserSettings_Bool("bDropUnusefulMelee") then
    return
  end
