...
function JumpVault:HandleVaultVisibility()
  ...
  SettingSubsystem:RegisterUserSettingsDelegate_Bool("VaultBtnSwitch", RefreshVaultBtnSwitch)
  RefreshVaultBtnSwitch(SettingSubsystem:GetUserSettings_Bool("VaultBtnSwitch"))
end
...
function JumpVault:AddChildForJump(ChildWidget, NodeName)
  if slua.isValid(ChildWidget) and self.UIRoot[NodeName] then
