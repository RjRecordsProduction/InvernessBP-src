...
function ChangeSightUI:RegistEvents()
  ...
  if SettingSubsystem then
    self.Handle_Switch = SettingSubsystem:RegisterUserSettingsDelegate_Bool("QuasiMirrorSwitch", function(bQuasiMirrorSwitch)
    ...
    local bValueFromSubsystem = SettingSubsystem:GetUserSettings_Bool("QuasiMirrorSwitch")
...
function ChangeSightUI:OnClose()
  local SettingSubsystem = SubsystemMgr:Get("SettingSubsystem")
  if SettingSubsystem then
    SettingSubsystem:UnregisterUserSettingDelegate(self.Handle_Switch)
  end
end
