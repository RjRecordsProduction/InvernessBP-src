...
function CircleChooseWidgetLogic:RegisterUserSettings()
  ...
  if uGameFrontendHUD then
    ...
    SettingSubsystem:RegisterUserSettingsDelegate_Bool("bConsumeThrow", function(bMedsThrowEnable)
      self:RefreshMedsThrowShow(bMedsThrowEnable)
    end)
    SettingSubsystem:RegisterUserSettingsDelegate_Bool("IntelligentDrugs", function(bIntelligentSort)
