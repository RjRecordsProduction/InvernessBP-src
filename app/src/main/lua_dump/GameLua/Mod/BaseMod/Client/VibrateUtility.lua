...
function VibrateUtilitySubSystem:BindEvent()
  ...
  if SettingSubsystem then
    SettingSubsystem:RegisterUserSettingsDelegate_Int("HapticSwitch", function(InHapticSwitch)
      if slua.isValid(self.VibrateSystemManager) then
        self.VibrateSystemManager:ModifyEntireVibrationLevel(InHapticSwitch)
      end
    end)
    SettingSubsystem:RegisterUserSettingsDelegate_Int("HapticVoiceSwitch", function(InHapticVoiceSwitch)
      if slua.isValid(self.VibrateSystemManager) then
        self.VibrateSystemManager:ModifySoundUIVibrationLevel(InHapticVoiceSwitch)
      end
    end)
    SettingSubsystem:RegisterUserSettingsDelegate_Int("HapticCharacterSwitch", function(HapticCharacterSwitch)
      if slua.isValid(self.VibrateSystemManager) then
        self.VibrateSystemManager:ModifyCharacterVibrationLevel(HapticCharacterSwitch)
      end
    end)
    SettingSubsystem:RegisterUserSettingsDelegate_Int("HapticWeaponSwitch", function(HapticWeaponSwitch)
      if slua.isValid(self.VibrateSystemManager) then
        self.VibrateSystemManager:ModifyWeaponVibrationLevel(HapticWeaponSwitch)
      end
    end)
    SettingSubsystem:RegisterUserSettingsDelegate_Int("HapticVehicleSwitch", function(HapticVehicleSwitch)
      if slua.isValid(self.VibrateSystemManager) then
        self.VibrateSystemManager:ModifyVehicleVibrationLevel(HapticVehicleSwitch)
      end
    end)
    SettingSubsystem:RegisterUserSettingsDelegate_Bool("bHapticVoiceStep", function(bHapticVoiceStep)
      if slua.isValid(self.VibrateSystemManager) then
        self.VibrateSystemManager:ModifyFootstepSoundUIVibrateSetting(bHapticVoiceStep)
      end
    end)
    SettingSubsystem:RegisterUserSettingsDelegate_Bool("bHapticVoiceGrass", function(bHapticVoiceGrass)
      if slua.isValid(self.VibrateSystemManager) then
        self.VibrateSystemManager:ModifyGlassBrokenSoundUIVibrateSetting(bHapticVoiceGrass)
      end
    end)
    SettingSubsystem:RegisterUserSettingsDelegate_Bool("bHapticVoiceGun", function(bHapticVoiceGun)
      if slua.isValid(self.VibrateSystemManager) then
        self.VibrateSystemManager:ModifyFireShotSoundUIVibrateSetting(bHapticVoiceGun)
      end
    end)
    SettingSubsystem:RegisterUserSettingsDelegate_Bool("bHapticVoiceVehicle", function(bHapticVoiceVehicle)
      if slua.isValid(self.VibrateSystemManager) then
        self.VibrateSystemManager:ModifyVehicleSoundUIVibrateSetting(bHapticVoiceVehicle)
      end
    end)
    SettingSubsystem:RegisterUserSettingsDelegate_Bool("bHapticCharacterBeGunAttack", function(bHapticCharacterBeGunAttack)
      if slua.isValid(self.VibrateSystemManager) then
        self.VibrateSystemManager:ModifyCharacterBeHitVibrateSetting(bHapticCharacterBeGunAttack)
      end
    end)
    SettingSubsystem:RegisterUserSettingsDelegate_Bool("bHapticCharacterBeOtherAttack", function(bHapticCharacterBeOtherAttack)
    end)
    SettingSubsystem:RegisterUserSettingsDelegate_Bool("bHapticCharacterFall", function(bHapticCharacterFall)
      if slua.isValid(self.VibrateSystemManager) then
        self.VibrateSystemManager:ModifyCharacterFallVibrateSetting(bHapticCharacterFall)
      end
    end)
    SettingSubsystem:RegisterUserSettingsDelegate_Bool("bHapticWeaponAttachment", function(bHapticWeaponAttachment)
      self.bEquipWeaponSwitch = bHapticWeaponAttachment
    end)
    SettingSubsystem:RegisterUserSettingsDelegate_Bool("bHapticWeaponAuto", function(bHapticWeaponAuto)
      if slua.isValid(self.VibrateSystemManager) then
        self.VibrateSystemManager:ModifyAutoWeaponVibrateSetting(bHapticWeaponAuto)
      end
    end)
    SettingSubsystem:RegisterUserSettingsDelegate_Bool("bHapticWeaponSemiAuto", function(bHapticWeaponSemiAuto)
      if slua.isValid(self.VibrateSystemManager) then
        self.VibrateSystemManager:ModifySemiAutoWeaponVibrateSetting(bHapticWeaponSemiAuto)
      end
    end)
    SettingSubsystem:RegisterUserSettingsDelegate_Bool("bHapticWeaponSniper", function(bHapticWeaponSniper)
      if slua.isValid(self.VibrateSystemManager) then
        self.VibrateSystemManager:ModifyBoltWeaponVibrateSetting(bHapticWeaponSniper)
      end
    end)
    SettingSubsystem:RegisterUserSettingsDelegate_Bool("bHapticWeaponOther", function(bHapticWeaponOther)
      if slua.isValid(self.VibrateSystemManager) then
        self.VibrateSystemManager:ModifyOtherWeaponVibrateSetting(bHapticWeaponOther)
      end
    end)
    SettingSubsystem:RegisterUserSettingsDelegate_Bool("bHapticVehicleDrive", function(bHapticVehicleDrive)
      if slua.isValid(self.VibrateSystemManager) then
        self.VibrateSystemManager:ModifyVehicleEngineVibrationSetting(bHapticVehicleDrive)
      end
    end)
    SettingSubsystem:RegisterUserSettingsDelegate_Bool("bHapticVehicleBeAttack", function(bHapticVehicleBeAttack)
      if slua.isValid(self.VibrateSystemManager) then
        self.VibrateSystemManager:ModifyVehicleBeHitVibrateSetting(bHapticVehicleBeAttack)
      end
    end)
    SettingSubsystem:RegisterUserSettingsDelegate_Bool("bHapticVehicleHit", function(bHapticVehicleHit)
      if slua.isValid(self.VibrateSystemManager) then
...
function VibrateUtilitySubSystem:HandleCharacterRespawned()
  print(bWriteLog and "VibrateUtilitySubSystem:HandleCharacterRespawned")
  self:InitVibrationSystem()
  self:BindCharacterDelegate()
end
...
function VibrateUtilitySubSystem:LoadUserSettingData()
  ...
  local SettingSubsystem = SubsystemMgr:Get("SettingSubsystem")
  if SettingSubsystem then
    local InCharacterVibrationLevel = SettingSubsystem:GetUserSettings_Int("HapticCharacterSwitch")
    local InWeaponVibrationLevel = SettingSubsystem:GetUserSettings_Int("HapticWeaponSwitch")
    local InVehicleVibrationLevel = SettingSubsystem:GetUserSettings_Int("HapticVehicleSwitch")
    local InSoundUIVibrationLevel = SettingSubsystem:GetUserSettings_Int("HapticVoiceSwitch")
    local bInCharacterBeHitVibrate = SettingSubsystem:GetUserSettings_Bool("bHapticCharacterBeGunAttack")
    local bInCharacterClimbVibrate = false
    local bInCharacterFallVibrate = SettingSubsystem:GetUserSettings_Bool("bHapticCharacterFall")
    local bInCharacterSwimVibrate = false
    local bInVehicleEngineVibrate = SettingSubsystem:GetUserSettings_Bool("bHapticVehicleDrive")
    local bInVehicleBeHitVibrate = SettingSubsystem:GetUserSettings_Bool("bHapticVehicleBeAttack")
    local bInVehicleCrashVibrate = SettingSubsystem:GetUserSettings_Bool("bHapticVehicleHit")
    local bInFootstepSoundUIVibrate = SettingSubsystem:GetUserSettings_Bool("bHapticVoiceStep")
    local bInFireShotSoundUIVibrate = SettingSubsystem:GetUserSettings_Bool("bHapticVoiceGun")
    local bInGlassBrokenSoundUIVibrate = SettingSubsystem:GetUserSettings_Bool("bHapticVoiceGrass")
    local bInVehicleSoundUIVibrate = SettingSubsystem:GetUserSettings_Bool("bHapticVoiceVehicle")
    local InEntireVibrationLevel = SettingSubsystem:GetUserSettings_Int("HapticSwitch")
    local bInAutoWeaponVibrate = SettingSubsystem:GetUserSettings_Bool("bHapticWeaponAuto")
    local bInSemiAutoWeaponVibrate = SettingSubsystem:GetUserSettings_Bool("bHapticWeaponSemiAuto")
    local bInBoltWeaponVibrate = SettingSubsystem:GetUserSettings_Bool("bHapticWeaponSniper")
    local bInOtherWeaponVibrate = SettingSubsystem:GetUserSettings_Bool("bHapticWeaponOther")
    self.bEquipWeaponSwitch = SettingSubsystem:GetUserSettings_Bool("bHapticWeaponAttachment")
