...
function ShootAimBtnUI:RegistEvents()
  ...
  self.RotateViewWithSniperSwitch = SettingSubsystem:GetUserSettings_Bool("RotateViewWithSniperSwitch")
  SettingSubsystem:RegisterUserSettingsDelegate_Bool("RotateViewWithSniperSwitch", function(RotateViewWithSniperSwitch)
    self.  end)
  self.UIRoot.MultiButton_ShootAim.ButtonType = SettingSubsystem:GetUserSettings_Int("OpenMirrorMode")
  SettingSubsystem:RegisterUserSettingsDelegate_Int("OpenMirrorMode", function(OpenMirrorMode)
    if not slua.isValid(self.UIRoot) then
      return
    end
    print(bWriteLog and "ShootAimBtnUI:RegistEvents OpenMirrorModeChanged", tostring(OpenMirrorMode))
...
function ShootAimBtnUI:HandleSightMirror()
  ...
  SettingSubsystem:RegisterUserSettingsDelegate_Int("SideMirrorMode", function(SideMirrorMode)
