...
function BackPackPanelUI:ShowToolTips()
  ...
  self.PickUpItemTips:UpdateData(self.CrtClickItem.UIRoot.Image_ItemIcon.Brush, ItemData and ItemData.ItemName or "", ItemData and ItemData.ItemDesc or "", ClickItemData.Count, ItemData and ItemData.UnitWeight_f or 0, TypeSpecificID)
...
function BackPackPanelUI:ShowArmoToolTips_SkillProp(SpecificID, Brush)
  ...
  self.PickUpItemTips:UpdateData(Brush, ItemData and ItemData.ItemName or "", ItemData and ItemData.ItemDesc or "", 1, ItemData and ItemData.UnitWeight_f or 0, SpecificID)
  self.PickUpItemTips:SetWidgetVisibility(UEnums.ESlateVisibility.SelfHitTestInvisible)
end
