...
function SoundVisualizationSubsystem:IsMainCanShowSoundVisualization()
  ...
  if not SettingSubsystem then
    print(bWriteLog and "SoundVisualizationSubsystem:IsMainCanShowSoundVisualization No SettingSubSystem")
    return false
  end
  local SettingValue = SettingSubsystem:GetUserSettings_Int("SoundVisualizationType")
