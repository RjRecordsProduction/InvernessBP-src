...
function ProneUIBP:HandleProneVisibility()
  ...
  SettingSubsystem:RegisterUserSettingsDelegate_Bool("OneKeyProneAndCrouchSwitch", RefreshProneVisibility)
  RefreshProneVisibility(SettingSubsystem:GetUserSettings_Bool("OneKeyProneAndCrouchSwitch"))
end
