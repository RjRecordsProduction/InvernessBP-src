...
function EntireMapWindow:CreateGameGuideUI()
  ...
  if not GameGuideUIMain then
    ...
    GameGuideUIMain = UIManager.ShowUI(UIManager.UI_Config_InGame.GameGuideUIMain, self.TargetNameID)
    self.TargetNameID = nil
  else
...
function EntireMapWindow:CloseGameGuideUI()
  ...
  if GameGuideUIMain then
    ...
    if ScriptHelperClient.GetMemorySize() > 2.9 then
      ...
      UIManager.CloseUI(UIManager.UI_Config_InGame.GameGuideUIMain)
    end
  end
end
  ...
  if bSelect then
    ...
    if not self.EntireMapGuideRedDot then
      ...
      if SettingSubsystem then
        SettingSubsystem:SetUserSettings_Bool("EntireMapGuideRedDot", true)
      end
    end
...
function EntireMapWindow:SetGuideRedDotCollapsed()
  ...
  self.EntireMapGuideRedDot = SettingSubsystem:GetUserSettings_Bool("EntireMapGuideRedDot")
...
function EntireMapWindow:GetEntireMapUI()
  return self:GetEntireMapUIBP().CurrentMapUI
end
