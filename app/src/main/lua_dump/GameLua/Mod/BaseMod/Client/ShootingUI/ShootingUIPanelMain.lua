...
function ShootingUIPanelIMP:OnInitializeDelay()
  ...
  self:CreateChildWindow("AutoSprintPanelRoot", UIManager.UI_Config_InGame.AutoSprintPanel)
end
...
function ShootingUIPanelIMP:HandleReleaseFire()
  print(bWriteLog and "ShootingUIPanelUIBase:HandleReleaseFire")
  local SettingSubsystem = SubsystemMgr:Get("SettingSubsystem")
  if not SettingSubsystem then
    return
  end
  self.ShotGunReleaseFireType = SettingSubsystem:GetUserSettings_Int("ShotGunShootMode") - 1
  SettingSubsystem:RegisterUserSettingsDelegate_Int("ShotGunShootMode", function(ShotGunShootMode)
    self.ShotGunReleaseFireType = ShotGunShootMode - 1
  end)
  self.SniperReleaseFireType = SettingSubsystem:GetUserSettings_Int("SingleShotWeaponShootMode") - 1
  SettingSubsystem:RegisterUserSettingsDelegate_Int("SingleShotWeaponShootMode", function(SingleShotWeaponShootMode)
...
function ShootingUIPanelIMP:SetSettingControlUI()
  ...
  local SettingSubsystem = SubsystemMgr:Get("SettingSubsystem")
  if SettingSubsystem then
    SettingSubsystem:RegisterUserSettingsDelegate_Int("LeftHandFire", function(LeftHandFire)
    ...
    self:LeftHandFireEvent(SettingSubsystem:GetUserSettings_Int("LeftHandFire"))
  else
    print(bWriteLog and "ShootingUIPanelUIBase:SetSettingControlUI Not SettingSubsystem")
  end
end
