local SubsystemConfig = {
  ...
  BattleResultRewardSubsystem = {
    module = "GameLua.Mod.BaseMod.Client.BattleResult.BattleResultRewardSubsystem",
    side = "Client"
  },
  LevelStreamingMgr = {
  ...
  ResultTaskSubsystem = {
    module = "GameLua.Mod.BaseMod.Client.BattleResult.Task.ResultTaskSubsystem",
    side = "Client"
  },
  DSPVSSubsystem = {
  ...
  ConfigDrivePlaneShowSubsystem = {
    module = "GameLua.Mod.BaseMod.Client.PlaneShow.ConfigDrivePlaneShowSubsystem",
    side = "Both"
  },
