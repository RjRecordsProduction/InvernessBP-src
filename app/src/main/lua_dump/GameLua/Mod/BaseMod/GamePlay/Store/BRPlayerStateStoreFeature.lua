...
BRPlayerStateStoreFeature.ServerRPC.RPC_Server_BuyGoods = {
  Reliable = true,
  Params = {
...
BRPlayerStateStoreFeature.ServerRPC.RPC_Server_OpenStore = {
  Reliable = true,
  Params = {
    import("/Script/Engine.Actor")
  }
}
BRPlayerStateStoreFeature.ServerRPC.RPC_Server_CloseStore = {
  Reliable = true,
  Params = {
    import("/Script/Engine.Actor"),
    UEnums.EPropertyClass.Int
...
BRPlayerStateStoreFeature.ServerRPC.RPC_Server_ShowNearestStore = {Reliable = true}
BRPlayerStateStoreFeature.ClientRPC.RPC_Client_BuyGoodsFinished = {
  Reliable = true,
  Params = {
