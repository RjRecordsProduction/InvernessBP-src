...
function OperateSubsystem:InitFovValue()
  ...
  local Crt_FpViewValue = SettingSubsystem:GetUserSettings_Int("FpViewValue")
  local Crt_TpViewValue = SettingSubsystem:GetUserSettings_Int("TpViewValue")
  ...
  SettingSubsystem:RegisterUserSettingsDelegate_Int("FpViewValue", function(FpViewValue)
    self:CustomEventChangeFOV(FpViewValue)
  end)
  SettingSubsystem:RegisterUserSettingsDelegate_Int("TpViewValue", function(TpViewValue)
...
function OperateSubsystem:GetShovelingSetting()
  ...
  if SettingSubsystem then
    return SettingSubsystem:GetUserSettings_Bool("ShovelSwitch")
  end
  return true
end
...
function OperateSubsystem:PressedLeftLean(PointerIndex)
  ...
  if slua.isValid(PlayerController) then
    ...
    if DataLayerSubsystem then
      local RotateViewWithPeekSwitch = DataLayerSubsystem:GetRotateViewWithPeekSwitch()
...
function OperateSubsystem:CancelThrow()
  ...
  if slua.isValid(BowState) then
    ...
    local uThrowComponent = uWeapon:GetComponentByClass(import("/Script/ShadowTrackerExtra.ThrowComponent"))
