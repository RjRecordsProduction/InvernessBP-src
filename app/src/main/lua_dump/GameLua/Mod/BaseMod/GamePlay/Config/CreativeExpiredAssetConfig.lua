local CreativeExpiredAssetConfig = {
  ...
  ExpiredAssetEditorPath = "/Game/Mod/CreativeBase/Arts_PlayerBluePrints/OfflineObject/BP_CreativeModeEditorActor_OfflineObject.BP_CreativeModeEditorActor_OfflineObject_C"
}
