local SkillActorInst = {
  ...
  Inst = {
    [0] = {
      PhaseData = {PhaseDuration = 10.333},
      PlayMontage01 = {
        AnimMontage = "/Game/Library/Res/AI/Centaur/Arts_Player/Animations/Centaur/Zombie170_int_Idle02_Montage.Zombie170_int_Idle02_Montage"
      }
    }
  }
}
