...
function Lobby_Mid_Shop_UIBP:ShowLobbyButton()
  ...
  if pass_enable then
    self.UIRoot.CanvasPanel_Rp:SetWidgetVisibility(UEnums.ESlateVisibility.SelfHitTestInvisible)
  else
    self.UIRoot.CanvasPanel_Rp:SetVisibility(UEnums.ESlateVisibility.Collapsed)
  end
end
