...
function SplashScreenUI.AssetUseHistoryInfo()
  ...
  log(bWriteLog and "VersionUpdateUI:OnUpdateFinished PakCollectResEnableOnlyDev: " .. PakCollectResEnableOnlyDev)
  ...
  log(bWriteLog and "VersionUpdateUI:OnUpdateFinished s.EnableCollectRes: " .. PakCollectResEnable)
...
function SplashScreenUI:RefreshUI()
  ...
  local path = "/Game/UMG/UI_BP/NewUpdate/SplashScreen_GL.SplashScreen_GL"
  if cr == PublishRegionMacros.JAPAN then
    path = "/Game/UMG/UI_BP/NewUpdate/SplashScreen_JP.SplashScreen_JP"
  elseif cr == PublishRegionMacros.KOREA then
    path = "/Game/UMG/UI_BP/NewUpdate/SplashScreen_KR.SplashScreen_KR"
  elseif cr == PublishRegionMacros.BLUEHOLE then
    path = "/Game/UMG/UI_BP/NewUpdate/SplashScreen_BH.SplashScreen_BH"
  end
