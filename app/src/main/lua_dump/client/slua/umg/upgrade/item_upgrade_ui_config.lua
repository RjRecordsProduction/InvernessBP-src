...
item_upgrade_ui_config.KillFeatureTabListConfig = {
  {
    ...
    SelectIconPath = "/Game/UMG/Texture_200/Atlas/Lobby_Store/Frames/Common_Tab_Counter_xuangzhong_png.Common_Tab_Counter_xuangzhong_png",
    UnSelectIconPath = "/Game/UMG/Texture_200/Atlas/Lobby_Store/Frames/Common_Tab_Counter_png.Common_Tab_Counter_png"
  },
  {
    TabType = item_upgrade_ui_config.KillFeatureTabType.LastKillEffectUI,
    UIConfigKeyName = "ItemUpgrade_LastKillEffects_UIBP",
    SelectIconPath = "/Game/UMG/Texture_200/Atlas/Lobby_Store/Frames/Common_Tab_Farewell_xuangzhong_png.Common_Tab_Farewell_xuangzhong_png",
    UnSelectIconPath = "/Game/UMG/Texture_200/Atlas/Lobby_Store/Frames/Common_Tab_Farewell_png.Common_Tab_Farewell_png"
  },
  {
    TabType = item_upgrade_ui_config.KillFeatureTabType.EliminationKing,
    UIConfigKeyName = "ItemUpgrade_EliminationKing_UIBP",
    SelectIconPath = "/Game/UMG/Texture_200/Atlas/Lobby_Store/Frames/Common_Tab_KingEliminationTips_xuangzhong_png.Common_Tab_KingEliminationTips_xuangzhong_png",
    UnSelectIconPath = "/Game/UMG/Texture_200/Atlas/Lobby_Store/Frames/Common_Tab_KingEliminationTips_png.Common_Tab_KingEliminationTips_png"
  }
}
