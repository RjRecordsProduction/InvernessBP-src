...
local GetSpecialMenuData = function(menu_id)
  ...
  local menuConfig = {
    [120] = {
      ...
      bgPath = "/Game/UMG/Texture/Lobby_NoAtlas/Lobby_Match_SelectMap/ModeSelection_New/BG/ModeSelection_Image_BG03.ModeSelection_Image_BG03",
      showBGMask = true,
      root = "CanvasPanel_PeakGame"
    },
    [config_arena.ModeMenuId] = {
      uiConfig = UIManager.UI_Config.ModeSelection_Map_Team_Item,
      bgPath = "/Game/UMG/Texture/Lobby_NoAtlas/Lobby_Match_SelectMap/ModeSelection_New/BG/ModeSelection_Image_BG06.ModeSelection_Image_BG06",
      showBGMask = false,
      root = "CanvasPanel_PeakGame",
    ...
    [260] = {
      ...
      bgPath = "/Game/UMG/Texture/Lobby_NoAtlas/Lobby_Match_SelectMap/ModeSelection_New/BG/ModeSelection_Image_BG09.ModeSelection_Image_BG09",
      showBGMask = true,
      root = "CanvasPanel_T"
    }
  }
...
function ModeSelection_Main_UIBP:ctor(selfType, url_params)
  ...
  self.ugcSeason = url_params and url_params.ugcSeason
  self.ugcSeasonMatch = url_params and url_params.openUgcSeasonMatch
  ...
  self.ForumBtnCfg = {
    [1] = {
      ...
      Pic = "/Game/UMG/Texture_200/Atlas/Common_New_Atlas/Frames/Common_Icon_Club_png.Common_Icon_Club_png",
      TlogFun = function()
        ...
        Logic_UGC_TLog:ReportCommercialClick({
          source = UGCMacros.Enum_UGC_CommercialClick_Type.Club
        })
      end,
      BtnFun = function()
        self:OnButton_UGCCommunity()
      end,
      BShowRedDot = false
    },
    [2] = {
    ...
    [7] = {
      ...
      Pic = "/Game/UMG/Texture_200/Lobby_NoAtlas/Ugc/AppreciationGroup/Ugc_Icon_AppreciationGroup_Brand.Ugc_Icon_AppreciationGroup_Brand",
      TlogFun = function()
        local Logic_UGC_TLog = ModuleManager.GetModule(ModuleManager.LobbyModuleConfig.Logic_UGC_TLog)
        local UGCMacros = require("client.slua.logic.ugc.ugc_macros")
        Logic_UGC_TLog:ReportCommercialClick({
...
function ModeSelection_Main_UIBP:OnPostInitialize()
  ...
  self.UGCSeasonData = CDataTable.GetTable("ugc_review_panel_season_table")
...
function ModeSelection_Main_UIBP:SetViewData(data)
  ...
  log_tree("[COLE]ModeSelection_Main_UIBP:SetViewData", data)
  ...
  local viewIndex = 0
  local hasFind = false
  self._refreshViewTimer = self:AddTimerOnce(0.05, function()
    ...
    self:SetTexture(self.UIRoot.Image_BgBasic, "/Game/UMG/Texture/Lobby_NoAtlas/Lobby_Match_SelectMap/ModeSelection_New/BG/ModeSelection_Image_BG10.ModeSelection_Image_BG10")
    self.UIRoot.WidgetSwitcher_BG:SetActiveWidgetIndex(0)
    self:AddTimerOnce(0.1, function()
      if not hasFind then
        viewIndex = 0
...
function ModeSelection_Main_UIBP:OnMenuAlphaItemRefresh(widget, index)
  ...
  if self.bShowChangeModeBtn then
    UgcIndex = 1
    self:SetWidgetVisible(self.UIRoot.Button_ChangeMode, true, true)
  end
  ...
  if widget.CanvasPanel_Download then
    local mode_selection_macro = require("client.slua.logic.mode_selection.mode_selection_macro")
    if data.id == mode_selection_macro.Enum_TabID.UGC then
      ...
      local downloader = common_download_handler.CreateDownloadUI(PufferConst.ENUM_DownloadType.MAP, {
        PufferConst.UGC_BASIC_MAPKEY
      }, widget.CanvasPanel_Download, params)
      if downloader then
        widget.Image_lock:SetWidgetVisibility(UEnums.GSlateVisibility.SelfHitTestInvisible)
        widget.TextBlock_Name_1:SetColorAndOpacity(FSlateColor(FLinearColor(0, 0, 0, 0.4)))
      end
    else
      widget.CanvasPanel_Download:ClearChildren()
    end
  end
end
...
function ModeSelection_Main_UIBP:OnMenuAlphaClick(widget, index, autoClick)
  ...
  self.betaMenuIndex = 0
  self:SetWidgetVisible(self.UIRoot.Button_Room, true, true)
...
function ModeSelection_Main_UIBP:OnMenuBetaClick(widget, index, autoClick)
  ...
  self:SetWidgetVisible(self.UIRoot.Canvas_NewbieProgressAward, data.id == mode_selection_macro.Enum_TabID.MatchNewbie and logic_newbie_mode_selection:CheckOpen())
  self:SetWidgetVisible(self.UIRoot.Button_MatchSetting, data.id ~= mode_selection_macro.Enum_TabID.MatchNewbie and data.id ~= 270, true)
...
function ModeSelection_Main_UIBP:OnClickUGCWarehouse()
  self:PlayAudio(sound_config.click)
  UIManager.ShowUI(UIManager.UI_Config.UGC_Inventory_UIBP)
end
...
function ModeSelection_Main_UIBP:OnButton_MatchSettingClick()
  ...
  local childUI = self:CreateChildWindow(self.UIRoot.CanvasPanel_Filter, UIManager.UI_Config.mode_selection_filter, self.filter_info, self.viewMenuData)
  childUI:SetAnchors(0, 0, 0, 0)
  childUI:SetOffsets(0, 0, 100, 30)
  self:RefreshMatchSetting(true)
end
...
function ModeSelection_Main_UIBP:SwitchUGC(isUGC)
  ...
  if isUGC then
    ...
    if self.UGCMainSubUI then
      self.UGCMainSubUI:CloseSelf()
      self.UGCMainSubUI = nil
    end
...
function ModeSelection_Main_UIBP:ShowUGC()
  ...
  if jumpbackData and jumpbackData.UGCMainUIData then
    tab = jumpbackData.UGCMainUIData.tab
    extendedParams = jumpbackData.UGCMainUIData.extendedParams or {}
  end
  ...
  extendedParams.ugcSeason = self.ugcSeason
  extendedParams.ugcSeasonMatch = self.ugcSeasonMatch
  ...
  local Config_UGC = require("client.slua.logic.ugc.config_ugc")
  if Config_UGC.NewWOWHall == 1 then
    self.UGCMainSubUI = self:CreateChildWindow(self.UIRoot.CanvasPanel_UGC, UIManager.UI_Config.UGCMainPanel, tab, extendedParams)
  elseif Config_UGC.NewWOWHall == 2 then
...
function ModeSelection_Main_UIBP:GetDataForJumpBack()
  ...
  if self.topMenuId == mode_selection_macro.Enum_TabID.UGC then
    uiData = {}
    local ui = self.UGCMainSubUI
    if ui and ui.GetDataForJumpBack then
      uiData.UGCMainUIData = ui:GetDataForJumpBack().uiData
    end
...
function ModeSelection_Main_UIBP:OnButton_UGCCommunity()
  ...
  local Config_UGC = require("client.slua.logic.ugc.config_ugc")
  local UGCMainPanel = UIManager.GetUI(UIManager.UI_Config.UGCMainPanel)
  local NewUGCMainPanel = UIManager.GetUI(UIManager.UI_Config.NewUGCMainPanel)
  local tagID
  if Config_UGC.NewWOWHall ~= 2 then
    if UGCMainPanel == nil then
      log(bWriteLog and "[zzw]ModeSelection_Main_UIBP:UGCMainPanel == nil")
      return
    end
    tagID = UGCMainPanel.nTab
  else
    if NewUGCMainPanel == nil then
      log(bWriteLog and "ModeSelection_Main_UIBP:NewUGCMainPanel == nil")
      return
    end
    tagID = NewUGCMainPanel.nTab
  end
  local Config_UGC = require("client.slua.logic.ugc.config_ugc")
...
function ModeSelection_Main_UIBP:UpdateUGCCommunityRedPoint()
  ...
  if active then
    ...
    if bCanGetEntry then
      self.ForumBtnCfg[1].BShowRedDot = true
    ...
    self.ForumBtnCfg[1].BShowRedDot = false
...
function ModeSelection_Main_UIBP:RefreshAppreciationGroupRedDot()
  ...
  if logic_ugc_appreciation_group and (logic_ugc_appreciation_group:HasAppreciationAward() or logic_ugc_appreciation_group:HasHistoryAppreciationAward()) then
    self.ForumBtnCfg[7].BShowRedDot = true
    self:RefreshForumRedPoint()
  else
    self.ForumBtnCfg[7].BShowRedDot = false
    self:RefreshForumRedPoint()
  end
end
...
function ModeSelection_Main_UIBP:RefreshMenuBetaScroll(_, _, bHomeTab)
  ...
  self:SetWidgetVisible(self.UIRoot.Button_Room, not bHomeTab, not bHomeTab)
...
function ModeSelection_Main_UIBP:OnRefreshSettingBtn(bHomeTab, bIsUGC)
  if LobbySystem.CheckOpen(910001) and not bHomeTab then
    self.UIRoot.Button_Setting:SetWidgetVisibility(UEnums.GSlateVisibility.Visible)
    if bIsUGC then
...
function ModeSelection_Main_UIBP:CheckUGCWarehousePoint()
  ...
  self.ForumBtnCfg[5].BShowRedDot = hasNew
  self:RefreshForumRedPoint()
end
function ModeSelection_Main_UIBP:OnRefreshButtonWoWPass(bHomeTab, bIsUGC)
  if not bHomeTab then
    ...
    if bIsUGC and bSwitch then
      self.UIRoot.Button_WoWPass:SetWidgetVisibility(UEnums.GSlateVisibility.Visible)
    else
      self.UIRoot.Button_WoWPass:SetWidgetVisibility(UEnums.GSlateVisibility.Collapsed)
    end
  else
    self.UIRoot.Button_WoWPass:SetWidgetVisibility(UEnums.GSlateVisibility.Collapsed)
  end
