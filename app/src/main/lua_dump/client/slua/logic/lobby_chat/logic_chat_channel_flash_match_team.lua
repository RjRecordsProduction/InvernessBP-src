...
function logic_chat_channel_flash_match_team.Init()
  ...
  logic_chat_channel_flash_match_team.TeamMemberProfileMap = {}
end
...
function logic_chat_channel_flash_match_team.ClearData()
  ...
  logic_chat_channel_flash_match_team.TeamMemberProfileMap = nil
...
function logic_chat_channel_flash_match_team.GetTeamMemberProfileByUid(uid)
  if not uid then
    return nil
  end
  if not logic_chat_channel_flash_match_team.TeamMemberProfileMap then
    return nil
  end
  return logic_chat_channel_flash_match_team.TeamMemberProfileMap[uid]
end
function logic_chat_channel_flash_match_team.UpdateTeamMemberProfileByUid(uid, profile)
  if not uid or not profile then
    log(bWriteLog and "logic_chat_channel_flash_match_team.UpdateTeamMemberProfileByUid - invalid param, uid: " .. tostring(uid))
    return
  end
  if not logic_chat_channel_flash_match_team.TeamMemberProfileMap then
    logic_chat_channel_flash_match_team.TeamMemberProfileMap = {}
  end
  logic_chat_channel_flash_match_team.TeamMemberProfileMap[uid] = profile
  log(bWriteLog and "logic_chat_channel_flash_match_team.UpdateTeamMemberProfileByUid - cached uid: " .. tostring(uid))
end
