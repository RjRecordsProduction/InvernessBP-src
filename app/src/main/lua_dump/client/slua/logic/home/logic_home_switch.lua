...
function logic_home_switch:InitRightModeData()
  ...
  if not _G.IsEditor and (PublishRegionMacros.IsCEVersion() or bGuest) then
    self.isShowLobbyRightMode = false
  end
...
function logic_home_switch:CheckHomeSwitchOpen(isShowTips)
