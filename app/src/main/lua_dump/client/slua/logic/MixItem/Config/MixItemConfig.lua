...
MixItemConfig.CommonItemZOrder = {
  [MixItemConfig.CommonItemName.Subtract] = 7,
  [MixItemConfig.CommonItemName.WealthValue] = 7,
  [MixItemConfig.CommonItemName.UseCount] = 7
}
