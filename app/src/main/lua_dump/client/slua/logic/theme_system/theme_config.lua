...
ThemeConfig.ThemeEntryMat = "/Game/UMG/Texture/Lobby_NoAtlas/Lobby_Match_SelectMap/ModeSelection_New/MapEntrance/Big/DX_FlowLight_DH09_Inst7.DX_FlowLight_DH09_Inst7"
ThemeConfig.ThemeEntryLoopMat = "/Game/UMG/Texture/Lobby_NoAtlas/Lobby_Match_SelectMap/ModeSelection_New/MapEntrance/Big/DX_FlowLight_Mode.DX_FlowLight_Mode"
...
function ThemeConfig.GetTabList()
  ...
  if logic_theme_task:IsThemeTaskOpen() then
    local taskTab = {
      ...
      UIConfig = UIManager.UI_Config.Theme_Task_UIBP,
      attachPanel = "CanvasPanel_BoxRoot"
    }
