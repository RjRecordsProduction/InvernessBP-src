...
function MatchSystem.StartMatchingTimer()
  ...
  local matchTimeTick = function()
    ...
    if not MatchSystem.bShowMatchTimeoutNotice and MatchSystem.nMatchingTime > C_MatchTimeoutSecond then
      local TeamUpNewSystem = require("client.slua.logic.teamup.logic_team_up")
      if TeamUpNewSystem.IsTeamLeader() then
        MatchSystem.ShowMatchTimeoutNotice()
      end
    end
