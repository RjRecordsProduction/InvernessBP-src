...
function ESportAllStarSystem.GetEntryInfo()
  local info = {
    ...
    sIcon_open = "/Game/UMG/Texture/Lobby_NoAtlas/ESport/Esport_Game_bg_01.Esport_Game_bg_01",
    logo_close = "/Game/UMG/Texture/Lobby_NoAtlas/ESport/Esport_Game_logo_hui_01.Esport_Game_logo_hui_01",
    logo_open = "/Game/UMG/Texture/Lobby_NoAtlas/ESport/Esport_Game_logo_01.Esport_Game_logo_01",
  ...
  if Client.GetPublishRegion() == PublishRegionMacros.BLUEHOLE then
    ...
    info.logo_close = "/Game/MultiRegion/Content/IN/UMG/Texture/Lobby_NoAtlas/ESport/Esport_Game_logo_hui_05.Esport_Game_logo_hui_05"
    info.logo_open = "/Game/MultiRegion/Content/IN/UMG/Texture/Lobby_NoAtlas/ESport/Esport_Game_logo_05.Esport_Game_logo_05"
  end
  return info
end
...
function ESportAllStarSystem.ShowPopupAndSaveData(prefsKey)
  local logoPath = "/Game/UMG/Texture/Lobby_NoAtlas/ESport/Esport_Game_logo_01.Esport_Game_logo_01"
...
function ESportAllStarSystem.CheckPushConditionTime(label_id)
  ...
  elseif label_id == 5 then
    log(bWriteLog and "[YY]\233\162\132\231\131\173\230\142\168\233\128\129==" .. tostring(1111111))
    ...
    if latestTime then
      log(bWriteLog and "[YY]\233\162\132\231\131\173\230\142\168\233\128\129==22222==" .. tostring(latestTime))
    end
  else
    log(bWriteLog and "[YY]CheckPushConditionTime=====\228\188\160\233\148\153\228\186\134")
    return false
  end
  if latestTime then
...
function ESportAllStarSystem.CheckPromoteGamePushCondition(label_id)
  ...
  elseif label_id == 4 then
    ...
    if bIsPromote and not isPlayOff then
      log(bWriteLog and "[ : ESportAllStarSystem.FindPromoteNextGame4====\229\164\141\232\181\155\230\153\139\231\186\167\229\134\179\232\181\155")
      return GetLatestTime(promoteTimes)
    end
    log(bWriteLog and "[ : ESportAllStarSystem.FindPromoteNextGame4====\233\153\132\229\138\160\232\181\155\230\153\139\231\186\167\229\134\179\232\181\155")
