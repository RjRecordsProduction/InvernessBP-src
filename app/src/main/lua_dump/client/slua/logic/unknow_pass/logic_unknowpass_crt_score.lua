...
function RPCrtScoreSystem.UpdateRpCrtScoreRedDot()
  ...
  Logic_Activity_Center.AddCenterRedDotForImage(BP_ENUM_MODULE_RP_CRT_SCORE, true, isShowRedDot)
...
function RPCrtScoreSystem.SyncTaskChangeInfo(sync_task_list)
  ...
  if show_red_point then
    local Logic_Activity_Center = require("client.slua.logic.activity.logic_activity_center")
    Logic_Activity_Center.AddCenterRedDotForImage(BP_ENUM_MODULE_RP_CRT_SCORE, true, true)
