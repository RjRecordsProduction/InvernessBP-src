...
function Util_UGC.SetUGCCollectionsImage(uiBase, widget, url, onSuccessCallback, templateId)
  ...
  if not url or url == "" then
    if templateId and templateId ~= 0 then
      ...
      uiBase:SetTexture(widget, "/Game/UMG/Texture/Lobby_NoAtlas/Lobby_Match_SelectMap/ModeSelection_New/MapEntrance/Small/Lobby_match_MapEntrance_S006_2x2.Lobby_match_MapEntrance_S006_2x2")
    end
...
function Util_UGC.ShowUGCShareCollectionListPanel(collectionData)
  ...
  local Config_UGC = require("client.slua.logic.ugc.config_ugc")
  local cfg = {
    capturePath = "/Game/UMG/Texture/Lobby_NoAtlas/Lobby_Match_SelectMap/ModeSelection_New/BG/ModeSelection_Image_BG02.ModeSelection_Image_BG02",
...
function Util_UGC.RefreshModePlayerNum(widget, mod_id, bShowFullNumber)
  ...
  if widget == nil or widget.HorizontalBox_Time == nil then
    return
  end
  UIUtil.SetWidgetVisible(widget.HorizontalBox_Time, true)
  UIUtil.SetWidgetVisible(widget.Online, false)
  if bShowFullNumber then
  end
  if widget.TextBlock_PlayTime == nil then
    return
  end
  ...
  if num >= Config_UGC.SimultaneousOnlinePopular then
    UIUtil.SetWidgetVisible(widget.Image_Hot_Line, true)
  ...
  elseif num < Config_UGC.SimultaneousOnlinePopular and num >= Config_UGC.SimultaneousOnlineModerate then
    UIUtil.SetWidgetVisible(widget.Image_Hot_Line, false)
