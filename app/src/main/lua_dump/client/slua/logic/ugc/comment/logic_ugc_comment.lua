...
function logic_ugc_comment:send_ugc_mark_feedback_read_status_req(feedback_table)
  self:Readfeedback(feedback_table)
  local UgcCommentHandler = require("client.network.Protocol.UgcCommentHandler")
  UgcCommentHandler.send_ugc_mark_feedback_read_status_req(feedback_table)
end
...
function logic_ugc_comment:Readfeedback(feedback_table)
