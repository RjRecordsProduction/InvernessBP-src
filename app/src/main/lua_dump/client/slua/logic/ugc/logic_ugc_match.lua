...
function Logic_UGC_Match:ReqStartGame(From)
  ...
  if UGCPlayHallRoom:IsSystemOpen() then
    ...
    Logic_UGC_TLog:SendStartGameTLog(self:GetMatchModID())
  end
...
function Logic_UGC_Match:OnGetLastGameRsp(ugcMatchInfo)
  ...
  local logic_home_wow_display = ModuleManager.GetModule(ModuleManager.CommonModuleConfig.logic_home_wow_display)
  logic_home_wow_display:AutoEntry()
end
