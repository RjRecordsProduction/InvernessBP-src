    ...
    Action = {
      ...
      Params = {
        GetUIFunc = function()
          ...
          local LoopScrollBox_Item02 = UI.UIRoot.LoopScrollBox_Item02
          if not LoopScrollBox_Item02 then
            return
          end
          local Item = LoopScrollBox_Item02:GetIndexOfWidget(1)
          if Item then
            return Item.Button_Skip, Item
          end
        end,
        BubbleConfigID = 26
      }
