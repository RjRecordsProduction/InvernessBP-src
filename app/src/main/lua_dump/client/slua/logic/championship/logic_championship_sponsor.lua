...
function ChampionshipSponsorSystem.GetEntryInfo()
  local info = {
    ...
    sIcon_open = "/Game/UMG/Texture/Lobby_NoAtlas/ESport/Esport_Game_bg_02.Esport_Game_bg_02",
    logo_close = "/Game/UMG/Texture/Lobby_NoAtlas/ESport/Esport_Game_logo_hui_04.Esport_Game_logo_hui_04",
    logo_open = "/Game/UMG/Texture/Lobby_NoAtlas/ESport/Esport_Game_logo_04.Esport_Game_logo_04",
  ...
  if Client.GetPublishRegion() == PublishRegionMacros.BLUEHOLE then
    ...
    info.logo_close = "/Game/MultiRegion/Content/IN/UMG/Texture/Lobby_NoAtlas/ESport/ESport_Sponsored_Match_logo_1.ESport_Sponsored_Match_logo_1"
    info.logo_open = "/Game/MultiRegion/Content/IN/UMG/Texture/Lobby_NoAtlas/ESport/ESport_Sponsored_Match_logo.ESport_Sponsored_Match_logo"
  end
  return info
end
