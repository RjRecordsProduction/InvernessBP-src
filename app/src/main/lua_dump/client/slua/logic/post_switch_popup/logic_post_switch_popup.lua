...
function logic_post_switch_popup:OnWidgetHide()
...
function logic_post_switch_popup:TryExecute(targetList)
  log_format("logic_post_switch_popup:TryExecute targetList = [%s]", targetList)
