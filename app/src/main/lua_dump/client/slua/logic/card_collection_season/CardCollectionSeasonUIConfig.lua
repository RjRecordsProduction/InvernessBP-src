  ...
  data = {
    {
      ...
      ImagePath = "/Game/UMG/UI_BP/CardCollection/NoAltas/ReturnActivity_OldFriend_01.ReturnActivity_OldFriend_01"
    },
    {
      title = LocUtil.GetLocalizeResStr(33020215),
      desc = LocUtil.GetLocalizeResStr(33020216),
      ImagePath = "/Game/UMG/UI_BP/CardCollection/NoAltas/ReturnActivity_OldFriend_02.ReturnActivity_OldFriend_02"
    },
    {
      title = LocUtil.GetLocalizeResStr(33020304),
      desc = LocUtil.GetLocalizeResStr(33020305),
      ImagePath = "/Game/UMG/UI_BP/CardCollection/NoAltas/ReturnActivity_OldFriend_03.ReturnActivity_OldFriend_03"
    },
    {
      title = LocUtil.GetLocalizeResStr(33020306),
      desc = LocUtil.GetLocalizeResStr(33020307),
      ImagePath = "/Game/UMG/UI_BP/CardCollection/NoAltas/ReturnActivity_OldFriend_04.ReturnActivity_OldFriend_04"
    }
  },
    ...
    data = {
      {
        title = LocUtil.GetLocalizeResStr(33020213),
        desc = LocUtil.GetLocalizeResStr(33020214),
        ImagePath = "/Game/UMG/UI_BP/CardCollection/NoAltas/CardCollection_Pass_01.CardCollection_Pass_01"
      },
      {
        title = LocUtil.GetLocalizeResStr(33020215),
        desc = LocUtil.GetLocalizeResStr(33020216),
        ImagePath = "/Game/UMG/UI_BP/CardCollection/NoAltas/CardCollection_Pass_02.CardCollection_Pass_02"
      },
      {
        title = LocUtil.GetLocalizeResStr(33020087),
        desc = LocUtil.GetLocalizeResStr(33020088),
        ImagePath = "/Game/UMG/UI_BP/CardCollection/NoAltas/CardCollection_Pass_03.CardCollection_Pass_03"
      },
      {
        title = LocUtil.GetLocalizeResStr(33020089),
        desc = LocUtil.GetLocalizeResStr(33020090),
        ImagePath = "/Game/UMG/UI_BP/CardCollection/NoAltas/CardCollection_Pass_04.CardCollection_Pass_04"
      }
    },
    title = LocUtil.GetLocalizeResStr(33020165)
  }
