...
function logic_memory_warning:ShowMemoryWarningTip()
  ...
  local jumpBtn = {
    callback = function()
      ...
      local bShowHighlight = true
      local SettingBasic = require("client.slua.logic.setting.logic_setting_basic")
      local WonderfulReplaySwitch1 = SettingBasic.GetOneSettingValue("bRecordWonderfulReplayOpen")
      local WonderfulReplaySwitch2 = SettingBasic.GetOneSettingValue("DeathPlaybackSwitch")
      ...
      SettingUtil.Enter("Game", {jumpKey = jumpkey, bForceHighlight = bShowHighlight})
    end
  }
