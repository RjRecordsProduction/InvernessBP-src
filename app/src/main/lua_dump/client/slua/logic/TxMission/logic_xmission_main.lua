...
function LogicTxMissionMain.OnEnterXMissionRsp(metro_scene_data, rate_up_data)
  ...
  if UIManager.IsUIShow(UIManager.UI_Config.xmission_main) then
    ...
    UIManager.AndroidBackToUI(UIManager.UI_Config.xmission_main.keyName)
    return
  end
...
function LogicTxMissionMain.HadXmissionActivity()
  ...
  log(bWriteLog and "LogicTxMissionMain.HadXmissionActivity. " .. tostring(next(ActivityCenterSystem.centerAllData) ~= nil))
  return next(ActivityCenterSystem.centerAllData) ~= nil
end
