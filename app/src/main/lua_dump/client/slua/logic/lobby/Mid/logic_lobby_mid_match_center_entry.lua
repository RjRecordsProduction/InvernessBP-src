...
function logic_lobby_mid_match_center_entry.HasMatchActivity()
  ...
  for _, activity in ipairs(activityData) do
    if ActivityCenterSystem.CanShowAct(activity) and activity.TabType == ActivitySwitchType.Sport and activity.DisplayScene and activity.DisplayScene[ActivityDisplayScene.Sport] then
