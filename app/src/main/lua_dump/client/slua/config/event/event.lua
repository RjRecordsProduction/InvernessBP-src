...
local Event_Config = {
  ...
  {
    eventType = EVENTTYPE_URL,
    eventID = BP_ENUM_MODULE_RETURN_REWARD_SLAP,
    moduleName = "client.slua.logic.player_return.logic_player_return_slap",
    funcName = "ShowNewRewardSlap"
  },
  {
    eventType = EVENTTYPE_URL,
  ...
  {
    eventType = EVENTTYPE_URL,
    eventID = BP_ENUM_MODULE_RETURN_NEW,
    moduleName = "client.slua.logic.player_return.logic_player_return_slap",
    funcName = "ShowNewReturnUI"
  },
  {
    eventType = EVENTTYPE_URL,
    eventID = BP_ENUM_MODULE_RETURN_BANNER_SLAP,
    moduleName = "client.slua.logic.player_return.logic_player_return_slap",
    funcName = "ShowNewBannerSlapUI"
  },
  {
    eventType = EVENTTYPE_URL,
  ...
  {
    eventType = EVENTTYPE_URL,
    eventID = BP_ENUM_MODULE_GOLDENSUIT_UPGRADE,
    moduleName = "client.slua.logic.XSuit.logic_xsuit",
  ...
  },
  {
    eventType = EVENTTYPE_STATE,
    eventID = EVENTID_ON_MODE_PRE_SWITCH,
    moduleName = "client.logic.season.logic_season_cycle_award",
    funcName = "OnGameStateChange"
  },
  {
    eventType = EVENTTYPE_URL,
  ...
  {
    eventType = EVENTTYPE_URL,
    eventID = BP_ENUM_MODULE_SEASON_MEMORY,
    moduleName = "client.logic.season.logic_season_cycle_memory",
    funcName = "ShowCycleMemoryUI"
  },
  {
    eventType = EVENTTYPE_STATE,
    eventID = EVENTID_ON_MODE_PRE_SWITCH,
