...
local wardrobe_ui_configs = {
  ...
  SharePackage_Edit_UIBP = {
    ...
    path = "/Game/UMG/UI_BP/Wardrobe/SharePackage/SharePackage_Edit_UIBP.SharePackage_Edit_UIBP",
  ...
  Wardrobe_New_DecomposePopups_Secondary_UIBP = {
    ...
    path = "/Game/UMG/UI_BP/Wardrobe/Wardrobe_New_DecomposePopups_Secondary_UIBP.Wardrobe_New_DecomposePopups_Secondary_UIBP",
    uiStat = {
  ...
  Wardrobe_New_DecomposePopups_UIBP = {
    ...
    path = "/Game/UMG/UI_BP/Wardrobe/Wardrobe_New_DecomposePopups_UIBP.Wardrobe_New_DecomposePopups_UIBP",
    uiStat = {
  ...
  Wardrobe_DecomposePopups_ChildPopups_UIBP = {
    ...
    path = "/Game/UMG/UI_BP/Wardrobe/Popup/Wardrobe_DecomposePopups_ChildPopups_UIBP.Wardrobe_DecomposePopups_ChildPopups_UIBP",
    uiStat = {
  ...
  Wardrobe_DecomposePopups_ChildPopups_Item_UIBP = {
    ...
    path = "/Game/UMG/UI_BP/Wardrobe/Wardrobe_DecomposePopups_ChildPopups_Item_UIBP.Wardrobe_DecomposePopups_ChildPopups_Item_UIBP",
    uiStat = {
  ...
  PlayGame_Award_Sub_UIBP_2 = {
    ...
    moduleName = "client.slua.umg.ReturnActivity.PlayGame_Award_Sub_UIBP",
  ...
  Subscribed_Award_Popup_UIBP = {
    ...
    path = "/Game/UMG/UI_BP/SpecialOffer/Popup/Subscribed_Award_Popup_UIBP.Subscribed_Award_Popup_UIBP",
    isMainUI = false,
    isSingleton = false,
    uiStat = {
  ...
  Wardrobe_EditTag_Popup_UIBP = {
    ...
    path = "/Game/UMG/UI_BP/Wardrobe/Popup/Wardrobe_EditTag_Popup_UIBP.Wardrobe_EditTag_Popup_UIBP",
    uiStat = {
  ...
  Wardrobe_Sift_Suit_Popup_UIBP = {
    ...
    path = "/Game/UMG/UI_BP/Wardrobe/Popup/Wardrobe_Sift_Suit_Popup_UIBP.Wardrobe_Sift_Suit_Popup_UIBP",
    asy = true,
    uiStat = {
  ...
  Wardrobe_TipsPanel_Favorites_UIBP = {
    ...
    path = "/Game/UMG/UI_BP/Wardrobe/WardrobeItem/Wardrobe_TipsPanel_Favorites_UIBP.Wardrobe_TipsPanel_Favorites_UIBP",
    asy = true,
    uiStat = {
  ...
  Wardrobe_Tag_NewGuide_Tips_UIBP = {
    ...
    path = "/Game/UMG/UI_BP/Wardrobe/WardrobeItem/Wardrobe_Tag_NewGuide_Tips_UIBP.Wardrobe_Tag_NewGuide_Tips_UIBP",
    asy = true,
    uiStat = {
  ...
  NewGuide_Tips_02_UIBP = {
    ...
    path = "/Game/UMG/UI_BP/Wardrobe/WardrobeItem/NewGuide_Tips_02_UIBP.NewGuide_Tips_02_UIBP",
    uiStat = {
  ...
  Wardrobe_Placard_Item_UIBP = {
    ...
    path = "/Game/UMG/UI_BP/Wardrobe/Wardrobe_Placard_Item_UIBP.Wardrobe_Placard_Item_UIBP",
    uiStat = {
  ...
  Wardrobe_ChangeHead_Popup_UIBP = {
    ...
    path = "/Game/UMG/UI_BP/Wardrobe/Popup/Wardrobe_ChangeHead_Popup_UIBP.Wardrobe_ChangeHead_Popup_UIBP",
    uiStat = {
