...
local shop_ui_configs = {
  ...
  Activty_PeriodicCrate_UIBP = {
    ...
    path = "/Game/UMG/UI_BP/NewActivty/Activty_PeriodicCrate_UIBP.Activty_PeriodicCrate_UIBP",
    uiStat = {
  ...
  allstar_exchangeshop = {
    ...
    path = "/Game/UMG/UI_BP/ESport/AllStar/AllStar_Exchange_UIBP.AllStar_Exchange_UIBP",
    uiStat = {
  ...
  Subscribe_HomePage_New_UIBP = {
    ...
    moduleName = "client.slua.umg.subscribe.Subscribe_HomePage_New_UIBP",
    path = "/Game/UMG/UI_BP/SpecialOffer/Subscribe_HomePage_New_UIBP.Subscribe_HomePage_New_UIBP",
    isMainUI = false,
    asy = true,
    uiStat = {
  ...
  Subscribe_HomePage_AwardItem = {
    ...
    moduleName = "client.slua.umg.subscribe.Subscribe_HomePage_AwardItem",
    path = "/Game/UMG/UI_BP/SpecialOffer/Item/Subscribe_HomePage_AwardItem.Subscribe_HomePage_AwardItem",
    isMainUI = false,
    isSingleton = false,
    uiStat = {
  ...
  Subscribed_Policy_Popup_JK_UIBP = {
    ...
    path = "/Game/UMG/UI_BP/SpecialOffer/Popup/Subscribed_Policy_Popup_JK_UIBP.Subscribed_Policy_Popup_JK_UIBP",
    containerName = UIContainers.Top,
    uiStat = {
  ...
  Subscribe_Slap_UIBP = {
    ...
    path = "/Game/UMG/UI_BP/SpecialOffer/Popup/Subscribe_Slap_UIBP.Subscribe_Slap_UIBP",
