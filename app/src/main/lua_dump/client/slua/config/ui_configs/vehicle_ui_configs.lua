...
local vehicle_ui_configs = {
  ...
  allstar_gp = {
    ...
    path = "/Game/UMG/UI_BP/ESport/AllStar/AllStar_GP_UIBP.AllStar_GP_UIBP",
    asy = true,
    uiStat = {
  ...
  allstar_schedule = {
    ...
    path = "/Game/UMG/UI_BP/ESport/AllStar/AllStar_Course_UIBP.AllStar_Course_UIBP",
    asy = true,
    uiStat = {
  ...
  allstar_share = {
    ...
    path = "/Game/UMG/UI_BP/ESport/AllStar/Enter_the_game/ESport_enter_Successful_share_UIBP.ESport_enter_Successful_share_UIBP",
    isSingleton = false,
    asy = true,
    uiStat = {
  ...
  allstar_face = {
    ...
    path = "/Game/UMG/UI_BP/ESport/AllStar/ESport_TournamentDescription_UIBP.ESport_TournamentDescription_UIBP",
    asy = true,
    uiStat = {
  ...
  allstar_result_popup = {
    ...
    path = "/Game/UMG/UI_BP/ESport/AllStar/Enter_the_game/ESport_enter_Successful_promotion_UIBP.ESport_enter_Successful_promotion_UIBP",
    asy = true,
    uiStat = {
  ...
  esport_select_team_flag = {
    ...
    path = "/Game/UMG/UI_BP/TournamentTeam/Alliance_Guidon_BP.Alliance_Guidon_BP",
    asy = true,
    uiStat = {
  ...
  esport_share = {
    ...
    path = "/Game/UMG/UI_BP/ESport/AllStar/Enter_the_game/ESport_enter_Successful_team_share_UIBP.ESport_enter_Successful_team_share_UIBP",
    isSingleton = false,
    asy = true,
    uiStat = {
  ...
  allstar_ob_room_waiting = {
    ...
    path = "/Game/UMG/UI_BP/ESport/AllStar/Enter_the_game/OB_RoomWating.OB_RoomWating",
    AndroidBackType = EAndroidBackType.Ban,
    uiStat = {
