...
local mail_ui_configs = {
  ...
  allstar_exchangegift = {
    ...
    path = "/Game/UMG/UI_BP/ESport/AllStar/AllStar_Exchange_Gift_UIBP.AllStar_Exchange_Gift_UIBP",
    asy = true,
    uiStat = {
  ...
  Activty_AdditionRecord_Popup_UIBP = {
    ...
    path = "/Game/UMG/UI_BP/NewActivty/Popup/Activty_AdditionRecord_Popup_UIBP.Activty_AdditionRecord_Popup_UIBP",
    uiStat = {
