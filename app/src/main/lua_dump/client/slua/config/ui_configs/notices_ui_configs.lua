...
local notices_ui_configs = {
  Notices_Main_UIBP = {
    ...
    path = "/Game/UMG/UI_BP/Login/Notices/Notices_Main_UIBP.Notices_Main_UIBP",
  ...
  Notices_ImageOrBlueprint_UIBP = {
    ...
    path = "/Game/UMG/UI_BP/Login/Notices/Notices_ImageOrBlueprint_UIBP.Notices_ImageOrBlueprint_UIBP",
    isMainUI = false,
    isSingleton = false,
  ...
  Notices_JKB_UIBP = {
    ...
    path = "/Game/UMG/UI_BP/Login/Notices/Notices_JKB_UIBP.Notices_JKB_UIBP",
    isMainUI = false,
    isSingleton = false,
    uiStat = {
  ...
  Notices_CollectionPage_UIBP = {
    ...
    path = "/Game/UMG/UI_BP/Login/Notices/Notices_CollectionPage_UIBP.Notices_CollectionPage_UIBP",
    loadFromPool = EUIConfigPoolType.None,
    isMainUI = false,
    isSingleton = false,
    uiStat = {
  ...
  Notices_CollectionPage_Theme_UIBP = {
    ...
    moduleName = "client.slua.umg.Notices.Notices_CollectionPage_UIBP",
    path = "/Game/UMG/UI_BP/Login/Notices/Notices_CollectionPage_Theme_UIBP.Notices_CollectionPage_Theme_UIBP",
    loadFromPool = EUIConfigPoolType.None,
    isMainUI = false,
    isSingleton = false,
    uiStat = {
