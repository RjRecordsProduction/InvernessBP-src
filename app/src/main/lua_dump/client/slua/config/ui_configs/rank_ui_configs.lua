...
local rank_ui_configs = {
  ...
  Rank_Creativity_main_BP = {
    ...
    path = "/Game/UMG/UI_BP/UGC/EventActivityCenter/UGC_Event_RankingList_UIBP.UGC_Event_RankingList_UIBP",
    isMainUI = false,
    uiStat = {
  ...
  ui_rank = {
    keyName = "ui_rank",
    moduleName = "client.slua.umg.rank.440.Rank_UIBP_440",
    path = "/Game/UMG/UI_BP/Rank/440/Rank_UIBP_440.Rank_UIBP_440",
  ...
  allstar_rank_main = {
    ...
    path = "/Game/UMG/UI_BP/ESport/AllStar/AllStar_Main_UIBP_2.AllStar_Main_UIBP_2",
  ...
  allstar_rank = {
    ...
    path = "/Game/UMG/UI_BP/ESport/AllStar/AllStar_Rank_UIBP.AllStar_Rank_UIBP",
  ...
  allstar_ban = {
    ...
    path = "/Game/UMG/UI_BP/ESport/AllStar/AllStar_Rank_Ban_UIBP.AllStar_Rank_Ban_UIBP",
    uiStat = {
  ...
  Test_ResultsRankingProtectUI = {
    ...
    moduleName = "GameLua.Mod.BaseMod.Client.BattleResult.Test_ResultsRankingProtectUI",
  ...
  PeakGame_Rank_UIBP = {
    ...
    path = "/Game/UMG/UI_BP/PeakGame/Rank/PeakGame_Rank_UIBP.PeakGame_Rank_UIBP",
  ...
  PeakGame_Weekly_Ranklist_UIBP = {
    ...
    path = "/Game/UMG/UI_BP/PeakGame/Rank/PeakGame_Weekly_Ranklist_UIBP.PeakGame_Weekly_Ranklist_UIBP",
    isMainUI = false,
    isSingleton = false,
    uiStat = {
  ...
  Lobby_PeakGame_Rank_Chart_UIBP = {
    ...
    path = "/Game/UMG/UI_BP/PeakGame/Lobby_PeakGame_Chart_Double_UIBP.Lobby_PeakGame_Chart_Double_UIBP",
    uiStat = {
  ...
  PeakGame_ResultsRanking_Protect_UIBPNew = {
    ...
    moduleName = "GameLua.Mod.BaseMod.Client.BattleResult.Test_PeakGame_ResultsRanking_Protect_UIBPNew",
  ...
  PeakGame_HOF_Ranklist_UIBP = {
    ...
    path = "/Game/UMG/UI_BP/PeakGame/Rank/PeakGame_HOF_Ranklist_UIBP.PeakGame_HOF_Ranklist_UIBP",
    isMainUI = false,
    isSingleton = false,
    uiStat = {
  ...
  PeakGame_Ability_Ranklist_UIBP = {
    ...
    path = "/Game/UMG/UI_BP/PeakGame/Rank/PeakGame_Ability_Ranklist_UIBP.PeakGame_Ability_Ranklist_UIBP",
    isMainUI = false,
    isSingleton = false,
    uiStat = {
  ...
  PeakGame_Rank_LevelUP_UIBP = {
    ...
    path = "/Game/UMG/UI_BP/PeakGame/Rank/PeakGame_Rank_LevelUP_UIBP.PeakGame_Rank_LevelUP_UIBP",
    uiStat = {
  ...
  PeakGame_Rank_Popup_UIBP = {
    ...
    path = "/Game/UMG/UI_BP/PeakGame/Popup/PeakGame_Rank_Popup_UIBP.PeakGame_Rank_Popup_UIBP",
    asy = true,
    uiStat = {
  ...
  PeakGame_Weekly_Award_UIBP = {
    ...
    path = "/Game/UMG/UI_BP/PeakGame/Rank/PeakGame_Award_UIBP.PeakGame_Award_UIBP",
    uiStat = {
  ...
  PeakGame_Ability_Award_UIBP = {
    ...
    path = "/Game/UMG/UI_BP/PeakGame/Rank/PeakGame_Ability_Award_UIBP.PeakGame_Ability_Award_UIBP",
    uiStat = {
  ...
  RankItemTwoHeader_UIBP = {
    ...
    moduleName = "client.slua.umg.Rank.RankItem.Header.RankItemTwoHeader_UIBP",
    path = "/Game/UMG/UI_BP/Rank/RankItem/Header/RankItemTwoHeader_UIBP.RankItemTwoHeader_UIBP",
    isMainUI = false,
    isSingleton = false,
  ...
  RankItemCommonDetail_UIBP = {
    ...
    moduleName = "client.slua.umg.rank.RankItem.Header.RankItemCommonDetail_UIBP",
    path = "/Game/UMG/UI_BP/Rank/RankItem/Header/RankItemCommonDetail_UIBP.RankItemCommonDetail_UIBP",
    isMainUI = false,
    isSingleton = false,
    loadFromPool = EUIConfigPoolType.other_pool,
    uiStat = {
  ...
  RankItemOneHeader_UIBP = {
    ...
    moduleName = "client.slua.umg.rank.RankItem.Header.RankItemOneHeader_UIBP",
    path = "/Game/UMG/UI_BP/Rank/RankItem/Header/RankItemOneHeader_UIBP.RankItemOneHeader_UIBP",
    isMainUI = false,
    isSingleton = false,
    loadFromPool = EUIConfigPoolType.other_pool,
    uiStat = {
  ...
  RankItemNoHeader_UIBP = {
    ...
    moduleName = "client.slua.umg.rank.RankItem.Header.RankItemNoHeader_UIBP",
    path = "/Game/UMG/UI_BP/Rank/RankItem/Header/RankItemNoHeader_UIBP.RankItemNoHeader_UIBP",
    isMainUI = false,
    isSingleton = false,
    loadFromPool = EUIConfigPoolType.other_pool,
    uiStat = {
  ...
  RankItemPVEDetail_UIBP = {
    ...
    moduleName = "client.slua.umg.rank.RankItem.Header.RankItemPVEDetail_UIBP",
    path = "/Game/UMG/UI_BP/Rank/RankItem/Header/RankItemPVEDetail_UIBP.RankItemPVEDetail_UIBP",
    isMainUI = false,
    isSingleton = false,
    loadFromPool = EUIConfigPoolType.other_pool,
    uiStat = {
  ...
  RankListItem_UIBP = {
    keyName = "RankListItem_UIBP",
    moduleName = "client.slua.umg.rank.RankListItem_UIBP",
    path = "/Game/UMG/UI_BP/Rank/RankListItem_UIBP.RankListItem_UIBP",
    isMainUI = false,
    isSingleton = false,
    loadFromPool = EUIConfigPoolType.other_pool,
    uiStat = {
      name = "\230\142\146\232\161\140\230\166\156item"
    }
  },
  RankItem_SimpleScore_UIBP = {
    keyName = "RankItem_SimpleScore_UIBP",
    moduleName = "client.slua.umg.Rank.RankItem.Score.RankItem_SimpleScore_UIBP",
    path = "/Game/UMG/UI_BP/Rank/RankItem/Score/RankItem_SimpleScore_UIBP.RankItem_SimpleScore_UIBP",
    isMainUI = false,
    isSingleton = false,
    loadFromPool = EUIConfigPoolType.other_pool,
    uiStat = {
      name = "\230\142\146\232\161\140\230\166\156\229\136\134\230\149\176\229\173\144\231\149\140\233\157\162-\231\174\128\229\141\149"
    }
  },
  RankItem_DetailScore_UIBP = {
    keyName = "RankItem_DetailScore_UIBP",
    moduleName = "client.slua.umg.rank.RankItem.Score.RankItem_DetailScore_UIBP",
    path = "/Game/UMG/UI_BP/Rank/RankItem/Score/RankItem_DetailScore_UIBP.RankItem_DetailScore_UIBP",
    isMainUI = false,
    isSingleton = false,
    loadFromPool = EUIConfigPoolType.other_pool,
    uiStat = {
      name = "\230\142\146\232\161\140\230\166\156-\229\136\134\230\149\176-\232\175\166\230\131\133-\229\173\144\231\149\140\233\157\162"
    }
  },
  RankItem_AliasTitle_UIBP = {
    keyName = "RankItem_AliasTitle_UIBP",
    moduleName = "client.slua.umg.rank.RankItem.Score.RankItem_AliasTitle_UIBP",
    path = "/Game/UMG/UI_BP/Rank/RankItem/Score/RankItem_AliasTitle_UIBP.RankItem_AliasTitle_UIBP",
    isMainUI = false,
    isSingleton = false,
    loadFromPool = EUIConfigPoolType.other_pool,
    uiStat = {
  ...
  RanItem_LevelInfo_UIBP = {
    ...
    moduleName = "client.slua.umg.rank.RankItem.Score.RanItem_LevelInfo_UIBP",
    path = "/Game/UMG/UI_BP/Rank/RankItem/Score/RanItem_LevelInfo_UIBP.RanItem_LevelInfo_UIBP",
    isMainUI = false,
    isSingleton = false,
    loadFromPool = EUIConfigPoolType.other_pool,
    uiStat = {
  ...
  RankItem_SimplePlanPHInfo_UIBP = {
    keyName = "RankItem_SimplePlanPHInfo_UIBP",
    moduleName = "client.slua.umg.Rank.RankItem.PlanPH.RankItem_PlanPHInfo_UIBP",
    path = "/Game/UMG/UI_BP/Rank/RankItem/PlanPH/RankItem_SimplePlanPHInfo_UIBP.RankItem_SimplePlanPHInfo_UIBP",
    isMainUI = false,
    isSingleton = false,
    loadFromPool = EUIConfigPoolType.other_pool,
    uiStat = {
      name = "\230\142\146\232\161\140\230\166\156\229\136\134\230\149\176-\229\174\182\229\155\173\228\191\161\230\129\175-\231\159\173\231\149\140\233\157\162"
    }
  },
  RankItem_DetailPlanPHInfo_UIBP = {
    keyName = "RankItem_DetailPlanPHInfo_UIBP",
    moduleName = "client.slua.umg.rank.RankItem.PlanPH.RankItem_PlanPHInfo_UIBP",
    path = "/Game/UMG/UI_BP/Rank/RankItem/PlanPH/RankItem_DetailPlanPHInfo_UIBP.RankItem_DetailPlanPHInfo_UIBP",
    isMainUI = false,
    isSingleton = false,
    loadFromPool = EUIConfigPoolType.other_pool,
    uiStat = {
      name = "\230\142\146\232\161\140\230\166\156\229\136\134\230\149\176-\229\174\182\229\155\173\228\191\161\230\129\175-\233\149\191\231\149\140\233\157\162"
    }
  },
  RankItem_DetailWOW_UIBP = {
    keyName = "RankItem_DetailWOW_UIBP",
    moduleName = "client.slua.umg.Rank.RankItem.WOW.RankItem_WOW_UIBP",
    path = "/Game/UMG/UI_BP/Rank/RankItem/WOW/RankItem_DetailWOW_UIBP.RankItem_DetailWOW_UIBP",
    isMainUI = false,
    isSingleton = false,
    loadFromPool = EUIConfigPoolType.other_pool,
    uiStat = {
      name = "\230\142\146\232\161\140\230\166\156\229\136\134\230\149\176-WOW\228\191\161\230\129\175-\233\149\191\231\149\140\233\157\162"
    }
  },
  RankItem_SimpleWOW_UIBP = {
    keyName = "RankItem_SimpleWOW_UIBP",
    moduleName = "client.slua.umg.rank.RankItem.WOW.RankItem_WOW_UIBP",
    path = "/Game/UMG/UI_BP/Rank/RankItem/WOW/RankItem_SimpleWOW_UIBP.RankItem_SimpleWOW_UIBP",
    isMainUI = false,
    isSingleton = false,
    loadFromPool = EUIConfigPoolType.other_pool,
    uiStat = {
      name = "\230\142\146\232\161\140\230\166\156\229\136\134\230\149\176-WOW\228\191\161\230\129\175-\231\159\173\231\149\140\233\157\162"
    }
  },
  RankItem_DetailTotalScore_UIBP = {
    keyName = "RankItem_DetailTotalScore_UIBP",
    moduleName = "client.slua.umg.rank.RankItem.TotalScore.RankItem_TotalScore_UIBP",
    path = "/Game/UMG/UI_BP/Rank/RankItem/TotalScore/RankItem_DetailTotalScore_UIBP.RankItem_DetailTotalScore_UIBP",
    isMainUI = false,
    isSingleton = false,
    loadFromPool = EUIConfigPoolType.other_pool,
    uiStat = {
      name = "\230\142\146\232\161\140\230\166\156\229\136\134\230\149\176-\230\128\187\229\136\134\230\149\176-\233\149\191\231\149\140\233\157\162"
    }
  },
  RankItem_SimpleTotalScore_UIBP = {
    keyName = "RankItem_SimpleTotalScore_UIBP",
    moduleName = "client.slua.umg.rank.RankItem.TotalScore.RankItem_TotalScore_UIBP",
    path = "/Game/UMG/UI_BP/Rank/RankItem/TotalScore/RankItem_SimpleTotalScore_UIBP.RankItem_SimpleTotalScore_UIBP",
    isMainUI = false,
    isSingleton = false,
    loadFromPool = EUIConfigPoolType.other_pool,
    uiStat = {
      name = "\230\142\146\232\161\140\230\166\156\229\136\134\230\149\176-\230\128\187\229\136\134\230\149\176-\231\159\173\231\149\140\233\157\162"
    }
  },
  RankItem_SpecialScore_UIBP = {
    keyName = "RankItem_SpecialScore_UIBP",
    moduleName = "client.slua.umg.rank.440.Item.RankItem_SpecialScore_UIBP",
    path = "/Game/UMG/UI_BP/Rank/440/itemFile/RankItem_SpecialScore_UIBP.RankItem_SpecialScore_UIBP",
    isMainUI = false,
    isSingleton = false,
    loadFromPool = EUIConfigPoolType.other_pool,
    uiStat = {
  ...
  RankItem_PlanPHScore_UIBP = {
    ...
    moduleName = "client.slua.umg.rank.440.Item.RankItem_PlanPHScore_UIBP",
    path = "/Game/UMG/UI_BP/Rank/440/itemFile/RankItem_PlanPHScore_UIBP.RankItem_PlanPHScore_UIBP",
    isMainUI = false,
    isSingleton = false,
    loadFromPool = EUIConfigPoolType.other_pool,
    uiStat = {
  ...
  RankItem_BaseScore_UIBP = {
    ...
    moduleName = "client.slua.umg.rank.440.Item.RankItem_BaseScore_UIBP",
    path = "/Game/UMG/UI_BP/Rank/440/itemFile/RankItem_BaseScore_UIBP.RankItem_BaseScore_UIBP",
    isMainUI = false,
    isSingleton = false,
    loadFromPool = EUIConfigPoolType.other_pool,
    uiStat = {
  ...
  Rank_List_Item_UIBP_440 = {
    ...
    moduleName = "client.slua.umg.rank.440.Rank_List_Item_UIBP_440",
    path = "/Game/UMG/UI_BP/Rank/440/Rank_List_Item_UIBP_440.Rank_List_Item_UIBP_440",
    isMainUI = false,
    isSingleton = false,
    loadFromPool = EUIConfigPoolType.other_pool,
    uiStat = {
  ...
  Rank_Reward_Item_UIBP = {
    ...
    moduleName = "client.slua.umg.rank.440.Item.Rank_Reward_Item_UIBP",
    path = "/Game/UMG/UI_BP/Rank/440/itemFile/Rank_Reward_Item_UIBP.Rank_Reward_Item_UIBP",
    isMainUI = false,
    isSingleton = false,
    loadFromPool = EUIConfigPoolType.other_pool,
    uiStat = {
