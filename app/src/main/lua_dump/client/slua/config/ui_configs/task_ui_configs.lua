...
local task_ui_configs = {
  ...
  Flap_Newbie_EightDays = {
    ...
    path = "/Game/UMG/UI_BP/DailyActivity/NoviceTask/Activity_EightDaysUIBP.Activity_EightDaysUIBP",
    uiStat = {
  ...
  EightDays_SelectAwardUI = {
    ...
    path = "/Game/UMG/UI_BP/DailyActivity/NoviceTask/Activity_Novice_Popup_UIBP.Activity_Novice_Popup_UIBP",
    uiStat = {
  ...
  NewbieTraining_New_UIBP = {
    ...
    path = "/Game/UMG/UI_BP/NewbieActivity/NewbieTraining/NewbieTraining_New_UIBP.NewbieTraining_New_UIBP",
    uiStat = {
  ...
  Newbie_Reward_Homepage_UIBP = {
    ...
    path = "/Game/UMG/UI_BP/NewbieActivity/NewbieReward/Newbie_Reward_Homepage_UIBP.Newbie_Reward_Homepage_UIBP",
    uiStat = {
  ...
  Newbie_Reward_MoreMission_UIBP = {
    ...
    path = "/Game/UMG/UI_BP/NewbieActivity/NewbieReward/Newbie_Reward_MoreMission_UIBP.Newbie_Reward_MoreMission_UIBP",
    uiStat = {
  ...
  Newbie_Reward_Middle_Item_UIBP = {
    ...
    path = "/Game/UMG/UI_BP/NewbieActivity/NewbieReward/Item/Newbie_Reward_Middle_Item_UIBP.Newbie_Reward_Middle_Item_UIBP",
    isMainUI = false,
    uiStat = {
  ...
  Newbie_Reward_Home_OptionsReward_UIBP = {
    ...
    path = "/Game/UMG/UI_BP/NewbieActivity/NewbieOptionsReward/Newbie_OptionsReward_UIBP.Newbie_OptionsReward_UIBP",
    uiStat = {
  ...
  NewbiePrivileges_Activity_HomePage_UIBP = {
    ...
    path = "/Game/UMG/UI_BP/NewbieActivity/NewbiePrivileges/NewbiePrivileges_Activity_HomePage_UIBP.NewbiePrivileges_Activity_HomePage_UIBP",
    uiStat = {
  ...
  NewbiePrivileges_Activity_HomePage_Tips_UIBP = {
    ...
    path = "/Game/UMG/UI_BP/NewbieActivity/NewbiePrivileges/Item/NewbiePrivileges_Activity_HomePage_Tips_UIBP.NewbiePrivileges_Activity_HomePage_Tips_UIBP",
    uiStat = {
  ...
  Newbie_Reward_Level_Sprint_UIBP = {
    ...
    path = "/Game/UMG/UI_BP/NewbieActivity/NewbieReward/Newbie_Reward_LevelSprint_UIBP.Newbie_Reward_LevelSprint_UIBP",
    uiStat = {
  ...
  Newbie_Reward_Eight_Days_UIBP = {
    ...
    path = "/Game/UMG/UI_BP/DailyActivity/NoviceTask/Activity_Novice_8Days_UIBP.Activity_Novice_8Days_UIBP",
    uiStat = {
  ...
  Financial_TemplateTask_UIBP = {
    ...
    moduleName = "client.slua.umg.Financial.Financial_TemplateTask_UIBP",
    path = "/Game/UMG/UI_BP/SpecialOffer/Financial_Task_UIBP.Financial_Task_UIBP",
    uiStat = {
  ...
  SmallPayment_Task_UIBP = {
    ...
    path = "/Game/UMG/UI_BP/SmallPayment/SmallPayment_Task_UIBP.SmallPayment_Task_UIBP",
    uiStat = {
  ...
  Activity_RoutineTasks2_UIBP = {
    ...
    path = "/Game/UMG/UI_BP/NewActivty/Activty_RoutineTasks_UIBP_2.Activty_RoutineTasks_UIBP_2",
    isMainUI = false,
    uiStat = {
  ...
  Activity_RoutineTasks3_UIBP = {
    ...
    path = "/Game/UMG/UI_BP/NewActivty/Activty_RoutineTasks_UIBP_3.Activty_RoutineTasks_UIBP_3",
    isMainUI = false,
    uiStat = {
  ...
  INTIMACY_DOUBLE_UIBP = {
    ...
    path = "/Game/UMG/UI_BP/NewActivty/Activty_RoutineTasks_UIBP_5.Activty_RoutineTasks_UIBP_5",
    isMainUI = false,
    uiStat = {
  ...
  PeakGame_Task_Popup_UIBP = {
    ...
    path = "/Game/UMG/UI_BP/PeakGame/Popup/PeakGame_Task_Popup_UIBP.PeakGame_Task_Popup_UIBP",
    uiStat = {
  ...
  NewbieTraining_Popup_UIBP = {
    ...
    path = "/Game/UMG/UI_BP/NewbieActivity/NewbieTraining/NewbieTraining_Popup_UIBP.NewbieTraining_Popup_UIBP",
    uiStat = {
  ...
  NewRecruit_SevenDayTask_UIBP = {
    ...
    path = "/Game/UMG/UI_BP/NewRecruit/SevenDayTask/NewRecruit_SevenDayTask_UIBP.NewRecruit_SevenDayTask_UIBP",
    uiStat = {
  ...
  NewRecruit_NewbieTask_UIBP = {
    ...
    path = "/Game/UMG/UI_BP/NewRecruit/NewbieTask/NewRecruit_NewbieTask_UIBP.NewRecruit_NewbieTask_UIBP",
    uiStat = {
  ...
  NewRecruit_DailyWish_UIBP = {
    ...
    path = "/Game/UMG/UI_BP/NewRecruit/DailyWish/NewRecruit_DailyWish_UIBP.NewRecruit_DailyWish_UIBP",
    uiStat = {
  ...
  NewRecruit_Welfare_UIBP = {
    ...
    path = "/Game/UMG/UI_BP/NewRecruit/Welfare/NewRecruit_Welfare_UIBP.NewRecruit_Welfare_UIBP",
    uiStat = {
  ...
  NewRecruit_NewcomerTutorial_UIBP = {
    ...
    path = "/Game/UMG/UI_BP/NewRecruit/NewcomerTutorial/NewRecruit_NewcomerTutorial_UIBP.NewRecruit_NewcomerTutorial_UIBP",
    uiStat = {
  ...
  NewRecruit_SevenDayTask_AwardsItem = {
    ...
    path = "/Game/UMG/UI_BP/NewRecruit/SevenDayTask/Item/NewRecruit_SevenDayTask_AwardsItem.NewRecruit_SevenDayTask_AwardsItem",
    isMainUI = false,
    isSingleton = false
  }
}
