...
local activity_ui_configs = {
  ...
  Activity_Newbie_EightDays = {
    ...
    path = "/Game/UMG/UI_BP/NewbieActivity/NovicEightDays/Activity_Novice_8Days_UIBP.Activity_Novice_8Days_UIBP",
    uiStat = {
  ...
  Activity_Newbie_Award = {
    ...
    path = "/Game/UMG/UI_BP/DailyActivity/NoviceTask/Activity_Novice_Reward_UIBP.Activity_Novice_Reward_UIBP",
    uiStat = {
  ...
  Activity_Newbie_Gift = {
    ...
    path = "/Game/UMG/UI_BP/NewbieActivity/NewbieSpin/Activity_Novice_UIBP.Activity_Novice_UIBP",
    uiStat = {
  ...
  Activity_Newbie_Training = {
    ...
    path = "/Game/UMG/UI_BP/NewbieActivity/NewbieTraining/NewbieTraining_UIBP.NewbieTraining_UIBP",
    uiStat = {
  ...
  Activity_Newbie_FriendsGathering = {
    ...
    path = "/Game/UMG/UI_BP/NewbieActivity/NewbieFriendsGathering/Newbie_FriendsGathering_UIBP.Newbie_FriendsGathering_UIBP",
    uiStat = {
  ...
  Activity_Newbie_Achievement = {
    ...
    path = "/Game/UMG/UI_BP/NewbieActivity/NewbieAchievement/Newbie_Achievement_UIBP.Newbie_Achievement_UIBP",
    uiStat = {
  ...
  Activity_Newbie_LevelSprint = {
    ...
    path = "/Game/UMG/UI_BP/NewbieActivity/LevelSprint/Newbie_LevelSprint_UIBP.Newbie_LevelSprint_UIBP",
    uiStat = {
  ...
  Activity_Newbie_Main = {
    ...
    path = "/Game/UMG/UI_BP/NewbieActivity/NewbieTab_Main_UIBP.NewbieTab_Main_UIBP",
    uiStat = {
  ...
  Activity_Newbie_Banner = {
    ...
    path = "/Game/UMG/UI_BP/NewbieActivity/Newbie_Banner.Newbie_Banner",
    uiStat = {
  ...
  EveryDayPack_Empty_Click = {
    ...
    moduleName = "client.slua.umg.lobby_activity.everydaypack.everydaypack_activity_empty_click",
  ...
  AdvertisingWheel_Main = {
    ...
    path = "/Game/Arts_UI/LuckyWidget/LndianLottery/AdvertisingWheel_Main_UIBP.AdvertisingWheel_Main_UIBP",
    isMainUI = false,
    uiStat = {
  ...
  LongTermSign_UIBP = {
    ...
    path = "/Game/UMG/UI_BP/NewActivty/LongTermSign_UIBP.LongTermSign_UIBP",
    uiStat = {
  ...
  Sink_Activity_UIBP = {
    ...
    path = "/Game/UMG/UI_BP/Sink/Sink_Activity_UIBP.Sink_Activity_UIBP",
    uiStat = {
      name = "\228\184\139\230\178\137\228\187\187\229\138\161\231\149\140\233\157\162"
    }
  },
  new_activity_center = {
    keyName = "new_activity_center",
    moduleName = "client.slua.umg.activity.new_activity_center.Activity_UIBP",
    jumpModuleID = BP_ENUM_MODULE_ACTIVITY,
    path = "/Game/UMG/UI_BP/NewActivty/Activty_UIBP.Activty_UIBP",
  ...
  Activity_Exchange_UIBP = {
    ...
    path = "/Game/UMG/UI_BP/NewActivty/Activty_Exchange_UIBP.Activty_Exchange_UIBP",
    isMainUI = false,
    uiStat = {
  ...
  Activity_Schedule_UIBP = {
    ...
    path = "/Game/UMG/UI_BP/NewActivty/Activty_Schedule_UIBP.Activty_Schedule_UIBP",
    isMainUI = false,
    uiStat = {
  ...
  Activity_Image_UIBP = {
    ...
    path = "/Game/UMG/UI_BP/NewActivty/Activty_Page3_UIBP.Activty_Page3_UIBP",
    isMainUI = false,
    uiStat = {
  ...
  Activity_Notice_UIBP = {
    ...
    path = "/Game/UMG/UI_BP/NewActivty/Activty_Page2_UIBP.Activty_Page2_UIBP",
    isMainUI = false,
    uiStat = {
  ...
  Activty_Page2_UIBP_New = {
    ...
    path = "/Game/UMG/UI_BP/NewActivty/Activty_Page2_UIBP_New.Activty_Page2_UIBP_New",
    isMainUI = false,
    uiStat = {
  ...
  Activity_Text_UIBP = {
    ...
    path = "/Game/UMG/UI_BP/NewActivty/Activty_Page4_UIBP.Activty_Page4_UIBP",
    isMainUI = false,
    uiStat = {
  ...
  Activity_EntrySet_UIBP = {
    ...
    path = "/Game/UMG/UI_BP/NewActivty/Activty_EntrySet_UIBP.Activty_EntrySet_UIBP",
    isMainUI = false,
    uiStat = {
  ...
  PassworRedEnvelope_UIBP = {
    ...
    path = "/Game/UMG/UI_BP/NewActivty/PassworRedEnvelope_UIBP.PassworRedEnvelope_UIBP",
    isMainUI = false,
    uiStat = {
  ...
  Activity_Area_UIBP = {
    ...
    path = "/Game/UMG/UI_BP/NewActivty/Area_Activity_UIBP.Area_Activity_UIBP",
    isMainUI = false,
    uiStat = {
  ...
  Activity_Gradually_UIBP = {
    ...
    path = "/Game/UMG/UI_BP/NewActivty/Gradually_Activity_UIBP.Gradually_Activity_UIBP",
    isMainUI = false,
    uiStat = {
  ...
  Activity_JumpEntry_UIBP = {
    ...
    path = "/Game/UMG/UI_BP/NewActivty/Activity_JumpEntry_UIBP.Activity_JumpEntry_UIBP",
    isMainUI = false,
    asy = true,
    uiStat = {
  ...
  Elegant_Ancient_Capital_UIBP = {
    ...
    path = "/Game/UMG/UI_BP/Home/Activity/Elegant_Ancient_Capital_UIBP.Elegant_Ancient_Capital_UIBP",
    isMainUI = false,
    AndroidBackType = EAndroidBackType.Skip,
    uiStat = {
  ...
  HomeActivity_Style_A_UIBP = {
    ...
    path = "/Game/UMG/UI_BP/Home/Activity/HomeActivity_Style_A_UIBP.HomeActivity_Style_A_UIBP",
    isMainUI = false,
    uiStat = {
  ...
  HomeActivity_Style_B_UIBP = {
    ...
    moduleName = "client.slua.umg.Home.Elegant_Ancient_Capital.HomeActivity_Style_UIBP",
    path = "/Game/UMG/UI_BP/Home/Activity/HomeActivity_Style_B_UIBP.HomeActivity_Style_B_UIBP",
    isMainUI = false,
    uiStat = {
  ...
  HomeActivity_Style_D_UIBP = {
    ...
    moduleName = "client.slua.umg.Home.Elegant_Ancient_Capital.HomeActivity_Style_UIBP",
    path = "/Game/UMG/UI_BP/Home/Activity/HomeActivity_Style_D_UIBP.HomeActivity_Style_D_UIBP",
    isMainUI = false,
    uiStat = {
