...
function UGCPassHandler.on_ugc_take_one_season_award_rsp(err_code, segment_id, awards)
  ...
  LogicUGCSeasonAward:take_season_task_prize_rsp(err_code, segment_id, awards)
end
...
function UGCPassHandler.on_ugc_get_season_rating_add_records_rsp(err_code, result)
  ...
  Logic_UGC_Season:OnAchievementRsq(result)
end
...
function UGCPassHandler.on_ugc_season_get_exchange_list_rsp(err_code, exchange_shop_list)
  ...
  log_tree("UGCPassHandler.on_ugc_season_get_exchange_list_rsp,exchange_shop_list = ", exchange_shop_list)
  local Logic_UGC_Season = ModuleManager.GetModule(ModuleManager.LobbyModuleConfig.logic_ugc_season)
  Logic_UGC_Season:SeasonExchangeListRsp(exchange_shop_list)
end
...
function UGCPassHandler.on_ugc_season_take_exchange_by_id_rsp(err_code, shop_id, shop_count, on_exchange_shop_list)
  ...
  log_tree("UGCPassHandler.on_ugc_season_take_exchange_by_id_rsp,exchange_shop_list = ", on_exchange_shop_list)
  local Logic_UGC_Season = ModuleManager.GetModule(ModuleManager.LobbyModuleConfig.logic_ugc_season)
  Logic_UGC_Season:TakeExchangeByIDRsp(shop_id, shop_count, on_exchange_shop_list)
end
