...
function UGCAuthorHandler.on_ugc_author_summary_rsp(err_code, author_uid, result, tb)
  ...
  EventSystem:postEvent(EVENTTYPE_UGC, EVENTID_UGC_AUTHOR_SUMMARY_RSP, author_uid, result)
end
