...
function LLMHandler.send_ugc_llm_get_sessions_v2_req(map_id)
  print(bWriteLog and "LLMHandler.send_ugc_llm_get_sessions_v2_req map_id:" .. tostring(map_id))
  NetManager.SendPkg(1882725247, map_id)
end
...
function LLMHandler.send_ugc_llm_one_chat_v2_req(map_id, chat_id)
  print(bWriteLog and "LLMHandler.send_ugc_llm_one_chat_v2_req map_id:" .. tostring(map_id) .. " chat_id:" .. tostring(chat_id))
  NetManager.SendPkg(391563235, map_id, chat_id)
end
...
function LLMHandler.send_ugc_llm_report_v2_req(chat_id, trace_id, reason_type, reason_content)
  print(bWriteLog and "LLMHandler.send_ugc_llm_report_v2_req chat_id:" .. tostring(chat_id) .. " trace_id:" .. tostring(trace_id) .. " reason_type:" .. tostring(reason_type) .. " reason_content:" .. tostring(reason_content))
  NetManager.SendPkg(970055367, chat_id, trace_id, reason_type, reason_content)
end
...
function LLMHandler.send_ugc_llm_chat_rating_v2_req(chat_id, trace_id, action)
  print(bWriteLog and "LLMHandler.send_ugc_llm_chat_rating_v2_req chat_id:" .. tostring(chat_id) .. " trace_id:" .. tostring(trace_id) .. " action:" .. tostring(action))
  NetManager.SendPkg(1727247847, chat_id, trace_id, action)
end
...
function LLMHandler.send_ugc_llm_chat_clear_sessions_req(map_id)
  print(bWriteLog and "LLMHandler.send_ugc_llm_chat_clear_sessions_req")
  NetManager.SendPkg(59987411, map_id)
end
...
function LLMHandler.on_ugc_llm_chat_switch_v2_rsp(flag, extra_switchs)
  ...
  if not flag then
    ...
    if extra_switchs and extra_switchs.edit_switch ~= nil then
