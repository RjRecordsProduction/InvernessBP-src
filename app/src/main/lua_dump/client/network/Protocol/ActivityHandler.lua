...
function ActivityHandler.on_get_activity_list_res(activityTable)
  ...
  ActivityRedDot.UpdateRedDotAdaptively(ActivityDisplayScene.Default)
  ActivityRedDot.UpdateRedDotAdaptively(ActivityDisplayScene.Sport)
