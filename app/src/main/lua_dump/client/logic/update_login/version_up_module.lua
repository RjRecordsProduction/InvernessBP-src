...
function version_up_module:ProcessDownloadedShader()
  log(bWriteLog and "login_module.ProcessDownloadedShader")
  local   local sProjectSavedDir = Client.ProjectSavedDir()
