...
local DEFAULT_BLUEHOLE_BG = "/Game/UMG/Texture/LoginUpdateUI/RGBA32/LOGIN_image_bg_1_kr_jp_.LOGIN_image_bg_1_kr_jp_"
local DEFAULT_BP = "/Game/UMG/UI_BP/Login/Login_UIPanelBG.Login_UIPanelBG"
local DEFAULT_JK_BP = "/Game/UMG/UI_BP/Login/LoginKPJP_UIPanelBG.LoginKPJP_UIPanelBG"
